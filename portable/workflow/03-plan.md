...
User duyệt spec xong là viết plan NGAY trong cùng turn.
...
`python3 scripts/tdq_state.py set phase=implement`,
rồi sang [04-build.md](04-build.md) **NGAY trong cùng turn**.
