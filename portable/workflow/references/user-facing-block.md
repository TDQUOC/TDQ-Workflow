...
Áp cho **mọi** chỗ workflow hỏi hoặc trình kết quả cho user. Người đọc là người dùng
cuối, không phải người trong nghề: họ cần biết đang xem cái gì, xem chi tiết ở đâu, và
phải trả lời thế nào.

## Bảy chỗ phải dùng khuôn này

Câu hỏi chọn pipeline · từng vòng interview · cổng duyệt spec · cổng duyệt plan ·
cổng chọn cách chạy (mode) · cổng duyệt chế độ nhanh · câu hỏi commit cuối request.
...
thay đổi. Kho gốc của workflow kiểm hộ việc này bằng một test whitelist ký hiệu.
