...
## Agent ngoài (không có skill system)

Coi mỗi công cụ/lệnh mình có là một "skill": liệt kê vào bảng, phán quyết như thường.
Với dòng DÙNG, ghi thêm vào ô cuối `tương đương: <công cụ/cách làm cụ thể>`.
