...
```
python3 "${CLAUDE_PROJECT_DIR}/.claude/tdq/scripts/tdq_checkportable.py" check
```
...
```
python3 "${CLAUDE_PROJECT_DIR}/.claude/tdq/scripts/tdq_checkportable.py" setup
```
...
```
python3 "${CLAUDE_PROJECT_DIR}/.claude/tdq/scripts/tdq_checkportable.py" setup --trust
```
