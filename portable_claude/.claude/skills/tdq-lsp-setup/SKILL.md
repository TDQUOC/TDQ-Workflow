...
`python3 scripts/tdq_lsp.py danh-thuc` wakes the daemon; `python3 scripts/tdq_lsp.py nha`
...
**Acceptance:** `python3 scripts/tdq_lsp.py kiem` prints six rungs ĐẠT and exits 0.
