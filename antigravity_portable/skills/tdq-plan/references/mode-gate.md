...
| 2 | Installed, not approved | có `codex` nhưng bạn chưa duyệt cho workflow gọi nó | `python3 ~/.gemini/config/plugins/tdq-workflow/scripts/tdq_checkportable.py setup` | <!-- i18n-allow: reason sentence printed verbatim by the check command -->
