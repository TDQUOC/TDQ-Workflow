...
## Corpus Check
- 350 files · ~283,028 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3315 nodes · 4550 edges · 323 communities (258 shown, 65 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `523e2113`
...
## Communities (323 total, 65 thin omitted)
...
### Community 17 - "QUICK — Format câu hỏi interview: mỗi option 1 dòng"
Cohesion: 0.40
...
### Community 20 - "StubBase"
Cohesion: 0.16
Nodes (10): good_report(), Dựng stub binary agy trong PATH + run-dir tạm. Không mạng, không binary thật., Response cho call agy -p thứ n. agy bọc structured_output trong JSON vỏ., T3.3 — 1 call search + ≤N call đọc URL; parse structured_output; gộp finding., T3.4 — retry ≤2 kèm lỗi cũ, retry dùng slug escalation., T3.7 — run-dir đúng run-id, brief.md copy vào, log per-agent ISO, LOG=0 tắt., RetryEscalationTest, RunLayoutLogTest (+2 more)
...
### Community 34 - "tdq-conventions/SKILL.md"
Cohesion: 0.23
...
### Community 43 - "Working log 2026-08-05"
Cohesion: 0.10
Nodes (19): 00:43 — Mở request tối ưu token vòng 2 (intake, chờ chốt lane), 00:52 — Phân tích vòng 2: đo lại chi phí, phát hiện token_audit đếm sai, 01:10 — Chốt interview vòng 2, viết knowledge + spec, 01:25 — User duyệt spec → viết plan (6 phase / 21 task), 02:04, 02:21, 02:27, 03:23 (+11 more)
...
### Community 50 - "Xử lý issue/lỗi do user báo"
Cohesion: 0.50
...
### Community 57 - "good_finding"
Cohesion: 0.32
Nodes (3): good_finding(), T1.1 — schema all-required, URL bắt buộc có path., SchemaTest
...
### Community 64 - "PLAN — TDQ 0.3.0 (instruction-hardening-7b)"
Cohesion: 0.14
...
### Community 67 - "test_claude_md_core.py"
Cohesion: 0.19
...
### Community 68 - "TestProjectRootResolution"
Cohesion: 0.17
...
### Community 69 - "PLAN — Hybrid deep search 0.6.0 (scout ∥ agy tổng quát → agy đào sâu)"
Cohesion: 0.17
...
### Community 70 - "Đợt 1 (21:13) — khả thi tổng quát"
Cohesion: 0.17
...
### Community 81 - "QC — 2026-07-31-audit-full-workflow"
Cohesion: 0.18
...
### Community 82 - "SPEC — TDQ 0.3.0: tuân thủ kiểm được, state đọc được, workflow đủ rõ cho mọi model"
Cohesion: 0.18
...
### Community 84 - "SPEC — TDQ workflow là default tuyệt đối + bỏ mục superpower (mục 5 cũ)"
Cohesion: 0.18
...
### Community 85 - "SPEC — Đưa skill vào gói external (hybrid 3 nhánh)"
Cohesion: 0.18
...
### Community 86 - "SPEC — 2026-08-04-approval-gate-bug"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+2 more)

### Community 87 - "SPEC — Đề xuất tối ưu time/token cho TDQ workflow"
Cohesion: 0.18
...
### Community 88 - "SPEC — Bump 0.7.0 + bộ export Claude Code đầy đủ, chạy được bằng một lệnh"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)

### Community 89 - "04-build.md"
Cohesion: 0.18
...
### Community 92 - "Knowledge — 2026-08-03-check-external-assign-flow"
Cohesion: 0.20
...
### Community 93 - "KNOWLEDGE — Bump version + export đầy đủ hơn"
Cohesion: 0.20
...
### Community 94 - "PLAN — Vá điểm mù verify-by-effect (0.3.1)"
Cohesion: 0.20
...
### Community 95 - "PLAN — Đổi thiết kế mode external: giao cả plan 1 lần + phase + verify 3 tầng"
Cohesion: 0.20
...
### Community 96 - "PLAN — Đưa skill vào gói external (hybrid 3 nhánh)"
Cohesion: 0.20
...
### Community 97 - "RESEARCH — Tối ưu token/time cho TDQ workflow"
Cohesion: 0.20
...
### Community 98 - "Research: Tối ưu token vòng 2 — biện pháp lâu dài cho agentic workflow"
Cohesion: 0.20
...
### Community 99 - "SPEC — Kiểm kê & tận dụng skill phụ trợ (tdq-workflow 0.3.3)"
Cohesion: 0.20
...
### Community 100 - "SPEC — Mode implement "external": giao task cho Codex/Antigravity qua worktree"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 101 - "SPEC — Tối ưu bộ plugin user-level: tier hoá, lazy-load, viết lại §10 (v1.0)"
Cohesion: 0.20
...
### Community 102 - "SPEC — Search agent "deep search" dùng agy CLI, tích hợp TDQ workflow"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 103 - "SPEC — Audit tổng thể TDQ workflow 0.6.0 (conflict, edge case, robustness model thấp)"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 104 - "SPEC — Hybrid deep search: Claude scout ∥ agy tổng quát → agy đào sâu"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 105 - "SPEC — Đổi thiết kế mode external: giao cả plan 1 lần + fix loop"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 106 - "SPEC — Bộ công cụ export cấu hình Claude Code sang máy khác"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 107 - "SPEC — TDQ workflow linh hoạt & bớt ma sát"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 108 - "TDQ Workflow — bản portable (agent nào cũng chạy được)"
Cohesion: 0.20
...
### Community 109 - "Quy tắc làm việc cho Claude"
Cohesion: 0.20
...
### Community 113 - "test_skill_docs.py"
Cohesion: 0.20
...
### Community 116 - "Plan — TDQWorkflow Plugin v0.1"
Cohesion: 0.22
...
### Community 117 - "KNOWLEDGE — external-agent-mode"
Cohesion: 0.22
...
### Community 118 - "Knowledge — 2026-08-04-approval-gate-bug"
Cohesion: 0.22
...
### Community 119 - "KNOWLEDGE — Tối ưu token/time cho TDQ workflow"
Cohesion: 0.22
...
### Community 120 - "Knowledge — 2026-08-04-workflow-linh-hoat"
Cohesion: 0.22
...
### Community 121 - "PLAN — Sửa lỗi approval-gate (nhắc nhở khi duyệt sai)"
Cohesion: 0.22
...
### Community 122 - "PLAN — Bộ công cụ export cấu hình Claude Code sang máy khác"
Cohesion: 0.22
...
### Community 123 - "PLAN — Đề xuất tối ưu time/token cho TDQ workflow"
Cohesion: 0.22
...
### Community 124 - "REPORT — Instruction hardening cho model yếu (tdq-workflow 0.3.0)"
Cohesion: 0.22
...
### Community 125 - "REPORT — Audit toàn diện tdq-workflow 0.6.0"
Cohesion: 0.22
...
### Community 126 - "REPORT — Đổi thiết kế mode external: giao cả plan / theo phase"
Cohesion: 0.22
...
### Community 127 - "REPORT — Đưa skill vào gói external (hybrid 3 nhánh)"
Cohesion: 0.22
...
### Community 128 - "REPORT — Sửa lỗi approval-gate (nhắc nhở khi duyệt sai)"
Cohesion: 0.22
...
### Community 129 - "REPORT — Bộ công cụ export cấu hình Claude Code sang máy khác"
Cohesion: 0.22
...
### Community 130 - "Kiểm kê năng lực (bước B0)"
Cohesion: 0.22
...
### Community 131 - "tdq-workflow — Plugin Claude Code"
Cohesion: 0.22
...
### Community 132 - "Deep search hybrid — Phase 1 (scout ∥ agy tổng quát) → Phase 2 (agy đào sâu)"
Cohesion: 0.22
...
### Community 133 - "Kiểm kê năng lực (bước B0)"
Cohesion: 0.22
...
### Community 137 - "KNOWLEDGE — Search agent dùng agy cho advanced search (2026-07-31)"
Cohesion: 0.25
...
### Community 138 - "Knowledge — 2026-07-31-hybrid-deep-search"
Cohesion: 0.25
...
### Community 139 - "KNOWLEDGE — 2026-08-02-tdq-default-cleanup"
Cohesion: 0.25
...
### Community 140 - "PLAN — Vá chặn oan do vân tay repo (0.3.2)"
Cohesion: 0.25
...
### Community 141 - "PLAN — Mode implement "external" (Codex/Antigravity qua worktree) — HOÀN THÀNH (mode main, 2026-07-30 23:10; Q9 PENDING chờ user cài plugin codex)"
Cohesion: 0.25
...
### Community 142 - "PLAN — Tối ưu bộ plugin user-level: tier hoá + lazy-load (HOÀN THÀNH — QC PASS 9/9, 14:58)"
Cohesion: 0.25
...
### Community 144 - "QC — Vá điểm mù verify-by-effect (0.3.1)"
Cohesion: 0.25
...
### Community 145 - "Vòng 1 (2026-08-05 03:2x) — đã hỏi, chờ trả lời"
Cohesion: 0.25
...
### Community 146 - "REPORT — Kiểm kê & tận dụng skill phụ trợ (tdq-workflow 0.3.3)"
Cohesion: 0.25
...
### Community 147 - "REPORT — Vá điểm mù verify-by-effect (tdq-workflow 0.3.1)"
Cohesion: 0.25
...
### Community 148 - "REPORT — Tối ưu time/token cho TDQ workflow"
Cohesion: 0.25
...
### Community 149 - "Research: 2026-08-04-export-claude-setup"
Cohesion: 0.25
...
### Community 150 - "Brief deep search — LLM local tham số thấp làm engine code-agent (2026-07-31)"
Cohesion: 0.25
...
### Community 169 - "RESEARCH — Bump version + export đầy đủ hơn"
Cohesion: 0.29
...
### Community 170 - "Brief deep search — LLM local tham số thấp làm engine code-agent (2026-07-31)"
Cohesion: 0.29
...
### Community 171 - "BRIEF — Vector database chạy local cho RAG (2026)"
Cohesion: 0.29
...
### Community 174 - "Chọn model & effort cho sub-agent"
Cohesion: 0.29
...
### Community 178 - "REQUEST — Format câu hỏi interview: mỗi option 1 dòng"
Cohesion: 0.40
Nodes (4): Chỗ chưa rõ, Cách hiểu đầu tiên, Nguyên văn yêu cầu của user, REQUEST — Format câu hỏi interview: mỗi option 1 dòng

### Community 182 - "KNOWLEDGE — instruction-hardening-7b (chốt trước khi viết spec)"
Cohesion: 0.33
...
### Community 183 - "KNOWLEDGE — Tối ưu plugin user-level + lazy-load"
Cohesion: 0.33
...
### Community 184 - "MINI-PLAN — Thực thi 5 task P0 tối ưu token"
Cohesion: 0.33
Nodes (5): Chốt từ interview, MINI-PLAN — Thực thi 5 task P0 tối ưu token, Rủi ro, Task, Validate cuối

### Community 185 - "QC — Kiểm kê & tận dụng skill phụ trợ (0.3.3)"
Cohesion: 0.33
...
### Community 186 - "QC — Mode implement "external" (Codex/Antigravity qua worktree)"
Cohesion: 0.33
...
### Community 187 - "QC — TDQ workflow là default tuyệt đối + bỏ mục superpower"
Cohesion: 0.33
...
### Community 188 - "REPORT — Mode implement "external" (Codex/Antigravity qua worktree)"
Cohesion: 0.33
...
### Community 189 - "Report — Hybrid deep search 2 phase (tdq-workflow 0.6.0)"
Cohesion: 0.33
...
### Community 190 - "REPORT — Workflow linh hoạt: gộp gate, quick đủ bước, lộ trình động"
Cohesion: 0.33
...
### Community 196 - "RESEARCH — Instruction/skills đủ chắc để model yếu đi đúng workflow"
Cohesion: 0.33
...
### Community 197 - "RESEARCH — Tối ưu plugin user-level + lazy-load"
Cohesion: 0.33
...
### Community 198 - "Research — 2026-07-31-hybrid-deep-search"
Cohesion: 0.33
...
### Community 199 - "Research — 2026-08-03-skill-vao-goi-external"
Cohesion: 0.33
...
### Community 202 - "Brief: phiên bản npm mới nhất của 2 package"
Cohesion: 0.33
...
### Community 205 - "04 — Build: Implement → QC → Report"
Cohesion: 0.33
...
### Community 206 - "06 — Deep search hybrid qua search_task.py (agy + search thường)"
Cohesion: 0.33
...
### Community 207 - "Khuôn gói cho engine ngoài (mode external)"
Cohesion: 0.33
...
### Community 208 - "TDQ Build — Implement → QC → Report"
Cohesion: 0.33
...
### Community 209 - "Vòng interview"
Cohesion: 0.40
Nodes (5): Ghi lại, Hỏi cái gì, Hỏi thế nào, Khi nào dừng, Vòng interview

### Community 212 - "test_search_task.py"
Cohesion: 0.08
Nodes (11): CallTimeoutTest, DeepSearchDocTest, DefaultModelTest, PreflightTest, Test search_task.py — deep search điều phối multi-call agy (stub binary, không m, T1.1 (0.6.0) — default flash-medium, escalation flash-high, docs đồng bộ., T3.2 — validate agy CLI + CẢ hai model slug qua external_models.py., T3.6 — call quá TDQ_SEARCH_TIMEOUT bị kill, tính 1 lần fail → retry. (+3 more)

### Community 214 - "Mã nhắc của hook"
Cohesion: 0.50
...
### Community 229 - "Research — 2026-07-31-audit-full-workflow"
Cohesion: 0.40
...
### Community 230 - "RESEARCH — 2026-08-02-tdq-default-cleanup"
Cohesion: 0.40
...
### Community 231 - "2.3 Thiết kế state file"
Cohesion: 0.40
...
- **Why does `write_state()` connect `.stop` to `load_fixture`, `helper.py`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `write_file()` connect `write_file` to `load_fixture`, `test_e2e_chain.py`, `helper.py`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **What connects `Đang ở đâu`, `Việc tiếp theo`, `Phạm vi` to the rest of the system?**
