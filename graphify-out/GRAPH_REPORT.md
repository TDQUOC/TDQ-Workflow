...
Cohesion: 0.06
Nodes (34): 0.10.0 — 2026-08-09, 0.11.0 — 2026-08-09, 0.1.0 — 2026-07-27, 0.1.4 — 2026-07-28, 0.1.6 — 2026-07-28, 0.2.0 — 2026-07-28, 0.3.0 — 2026-07-29, 0.3.1 — 2026-07-29 (+26 more)
...
### Community 60 - "PLAN — Hybrid deep search 0.6.0 (scout ∥ agy tổng quát → agy đào sâu)"
Cohesion: 0.17
...
### Community 66 - "ĐỀ XUẤT — Tối ưu time/token cho TDQ workflow"
Cohesion: 0.18
...
### Community 67 - "Kiến thức chốt — tối ưu token/time workflow (vòng 2)"
Cohesion: 0.18
...
### Community 68 - "PLAN — Audit tổng thể TDQ workflow 0.6.0 — HOÀN THÀNH"
Cohesion: 0.18
...
### Community 69 - "PLAN — TDQ workflow là default tuyệt đối + bỏ §5 superpower"
Cohesion: 0.18
...
### Community 70 - "PLAN — TDQ workflow linh hoạt & bớt ma sát"
Cohesion: 0.18
...
### Community 71 - "PLAN — Siết QC và vòng fix cho lane quick"
Cohesion: 0.18
...
### Community 72 - "QC — 2026-07-31-audit-full-workflow"
Cohesion: 0.18
...
### Community 73 - "SPEC — TDQ 0.3.0: tuân thủ kiểm được, state đọc được, workflow đủ rõ cho mọi model"
Cohesion: 0.18
...
### Community 75 - "SPEC — TDQ workflow là default tuyệt đối + bỏ mục superpower (mục 5 cũ)"
Cohesion: 0.18
...
### Community 76 - "SPEC — Đưa skill vào gói external (hybrid 3 nhánh)"
Cohesion: 0.18
...
### Community 77 - "SPEC — 2026-08-04-approval-gate-bug"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+2 more)

### Community 78 - "SPEC — Đề xuất tối ưu time/token cho TDQ workflow"
Cohesion: 0.18
...
### Community 79 - "SPEC — Audit toàn bộ workflow TDQ, đề xuất tối ưu token/thời gian (vòng 3)"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)

### Community 80 - "SPEC — Bump 0.7.0 + bộ export Claude Code đầy đủ, chạy được bằng một lệnh"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)

### Community 81 - "SPEC — Triển khai 16 đề xuất P0+P1 tối ưu workflow TDQ & user-level Claude Code"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)

### Community 82 - "SPEC — Siết QC và vòng fix cho lane quick"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)

### Community 83 - "SPEC — Giảm over-engineer & over-test cho TDQ workflow"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)

### Community 84 - "tdq-intake/SKILL.md"
Cohesion: 0.24
...
### Community 87 - "Quy tắc làm việc cho Claude"
Cohesion: 0.18
...
### Community 88 - "Knowledge — 2026-08-03-check-external-assign-flow"
Cohesion: 0.20
...
### Community 89 - "KNOWLEDGE — Bump version + export đầy đủ hơn"
Cohesion: 0.20
...
### Community 90 - "KNOWLEDGE — Brainstorm + spec triển khai P0+P1 tối ưu workflow & user-level Claude Code"
Cohesion: 0.20
...
### Community 91 - "PLAN — Vá điểm mù verify-by-effect (0.3.1)"
Cohesion: 0.20
...
### Community 92 - "PLAN — Đổi thiết kế mode external: giao cả plan 1 lần + phase + verify 3 tầng"
Cohesion: 0.20
...
### Community 93 - "PLAN — Đưa skill vào gói external (hybrid 3 nhánh)"
Cohesion: 0.20
...
### Community 94 - "Vòng 1 (2026-08-05 13:35)"
Cohesion: 0.20
...
### Community 106 - "{{BUNDLE_NAME}} — Claude Code setup export"
Cohesion: 0.22
...
### Community 108 - "Plan — TDQWorkflow Plugin v0.1"
Cohesion: 0.22
...
### Community 109 - "KNOWLEDGE — external-agent-mode"
Cohesion: 0.22
...
### Community 110 - "Knowledge — 2026-08-04-approval-gate-bug"
Cohesion: 0.22
...
### Community 111 - "KNOWLEDGE — Tối ưu token/time cho TDQ workflow"
Cohesion: 0.22
...
### Community 112 - "Knowledge — 2026-08-04-workflow-linh-hoat"
Cohesion: 0.22
...
### Community 113 - "KNOWLEDGE — Siết QC và vòng fix cho lane quick"
Cohesion: 0.22
...
### Community 114 - "Knowledge — 2026-08-08-giam-over-engineer-workflow"
Cohesion: 0.22
...
### Community 115 - "PLAN — Sửa lỗi approval-gate (nhắc nhở khi duyệt sai)"
Cohesion: 0.22
...
### Community 116 - "PLAN — Bộ công cụ export cấu hình Claude Code sang máy khác"
Cohesion: 0.22
...
### Community 117 - "PLAN — Đề xuất tối ưu time/token cho TDQ workflow"
Cohesion: 0.22
...
### Community 118 - "REPORT — Instruction hardening cho model yếu (tdq-workflow 0.3.0)"
Cohesion: 0.22
...
### Community 119 - "REPORT — Audit toàn diện tdq-workflow 0.6.0"
Cohesion: 0.22
...
### Community 120 - "REPORT — Đổi thiết kế mode external: giao cả plan / theo phase"
Cohesion: 0.22
...
### Community 121 - "REPORT — Đưa skill vào gói external (hybrid 3 nhánh)"
Cohesion: 0.22
...
### Community 122 - "REPORT — Sửa lỗi approval-gate (nhắc nhở khi duyệt sai)"
Cohesion: 0.22
...
### Community 123 - "REPORT — Bộ công cụ export cấu hình Claude Code sang máy khác"
Cohesion: 0.22
...
### Community 124 - "Working log 2026-08-07"
Cohesion: 0.22
...
### Community 125 - "tdq-workflow — Plugin Claude Code"
Cohesion: 0.22
...
### Community 127 - "Hướng dẫn tự cài tdq-workflow ở user-level (thủ công)"
Cohesion: 0.25
...
### Community 128 - "KNOWLEDGE — Search agent dùng agy cho advanced search (2026-07-31)"
Cohesion: 0.25
...
### Community 129 - "Knowledge — 2026-07-31-hybrid-deep-search"
Cohesion: 0.25
...
### Community 130 - "KNOWLEDGE — 2026-08-02-tdq-default-cleanup"
Cohesion: 0.25
...
### Community 131 - "PLAN — Vá chặn oan do vân tay repo (0.3.2)"
Cohesion: 0.25
...
### Community 132 - "PLAN — Mode implement "external" (Codex/Antigravity qua worktree) — HOÀN THÀNH (mode main, 2026-07-30 23:10; Q9 PENDING chờ user cài plugin codex)"
Cohesion: 0.25
...
### Community 133 - "PLAN — Tối ưu bộ plugin user-level: tier hoá + lazy-load (HOÀN THÀNH — QC PASS 9/9, 14:58)"
Cohesion: 0.25
...
### Community 134 - "PLAN — Audit toàn bộ workflow TDQ, đề xuất tối ưu token/thời gian (vòng 3)"
Cohesion: 0.25
...
### Community 136 - "QC — Vá điểm mù verify-by-effect (0.3.1)"
Cohesion: 0.25
...
### Community 137 - "Vòng 1 (2026-08-05 03:2x) — đã hỏi, chờ trả lời"
Cohesion: 0.25
...
### Community 138 - "REPORT — Kiểm kê & tận dụng skill phụ trợ (tdq-workflow 0.3.3)"
Cohesion: 0.25
...
### Community 139 - "REPORT — Vá điểm mù verify-by-effect (tdq-workflow 0.3.1)"
Cohesion: 0.25
...
### Community 140 - "REPORT — Tối ưu time/token cho TDQ workflow"
Cohesion: 0.25
...
### Community 141 - "REPORT — Giảm over-engineer & over-test cho TDQ workflow"
Cohesion: 0.25
...
### Community 142 - "Research: 2026-08-04-export-claude-setup"
Cohesion: 0.25
...
### Community 143 - "Brief deep search — LLM local tham số thấp làm engine code-agent (2026-07-31)"
Cohesion: 0.25
...
### Community 144 - "Kiểm kê năng lực (bước B0)"
Cohesion: 0.29
...
### Community 147 - "INSTRUCTIONS — Dựng bundle export cấu hình Claude Code"
Cohesion: 0.29
...
### Community 148 - "Report — TDQWorkflow Plugin v0.1.0 — 2026-07-27"
Cohesion: 0.29
...
### Community 149 - "Knowledge — 2026-07-31-audit-full-workflow"
Cohesion: 0.29
...
### Community 150 - "Knowledge — 2026-08-03-skill-vao-goi-external"
Cohesion: 0.29
...
### Community 151 - "Knowledge: 2026-08-04-export-claude-setup"
Cohesion: 0.29
...
### Community 153 - "QC — Tối ưu plugin user-level: tier hoá + lazy-load"
Cohesion: 0.29
...
### Community 154 - "REPORT — Vá chặn oan do vân tay repo (tdq-workflow 0.3.2)"
Cohesion: 0.29
Nodes (6): Còn lại, Kết quả QC, REPORT — Vá chặn oan do vân tay repo (tdq-workflow 0.3.2), Vấn đề, Đã làm gì, Đầu ra

### Community 155 - "REPORT — Tối ưu bộ plugin user-level: tier hoá + lazy-load"
Cohesion: 0.29
...
### Community 156 - "Request: Claude tự quyết implement mode, không hỏi user"
Cohesion: 0.29
...
### Community 157 - "Request: state phải luôn nằm ở project root (chống "state bóng")"
Cohesion: 0.29
...
### Community 158 - "RESEARCH — Search agent dùng agy (2026-07-31)"
Cohesion: 0.29
...
### Community 159 - "Research — 2026-08-04-approval-gate-bug"
Cohesion: 0.29
...
### Community 160 - "Research: Giảm chi phí token/thời gian dài hạn cho agentic coding workflow"
Cohesion: 0.29
...
### Community 161 - "RESEARCH — Bump version + export đầy đủ hơn"
Cohesion: 0.29
...
### Community 162 - "Brief deep search — LLM local tham số thấp làm engine code-agent (2026-07-31)"
Cohesion: 0.29
...
### Community 168 - "KNOWLEDGE — Tối ưu plugin user-level + lazy-load"
Cohesion: 0.33
...
### Community 169 - "MINI-PLAN — Thực thi 5 task P0 tối ưu token"
Cohesion: 0.33
Nodes (5): Chốt từ interview, MINI-PLAN — Thực thi 5 task P0 tối ưu token, Rủi ro, Task, Validate cuối

### Community 170 - "QC — Kiểm kê & tận dụng skill phụ trợ (0.3.3)"
Cohesion: 0.33
...
### Community 171 - "QC — Mode implement "external" (Codex/Antigravity qua worktree)"
Cohesion: 0.33
...
### Community 172 - "QC — TDQ workflow là default tuyệt đối + bỏ mục superpower"
Cohesion: 0.33
...
### Community 173 - "QUESTIONS — Siết QC và vòng fix cho lane quick"
Cohesion: 0.33
...
### Community 174 - "Vòng 1 — 2026-08-08 21:5x"
Cohesion: 0.33
...
### Community 175 - "REPORT — Mode implement "external" (Codex/Antigravity qua worktree)"
Cohesion: 0.33
...
### Community 176 - "Report — Hybrid deep search 2 phase (tdq-workflow 0.6.0)"
Cohesion: 0.33
...
### Community 177 - "REPORT — Workflow linh hoạt: gộp gate, quick đủ bước, lộ trình động"
Cohesion: 0.33
Nodes (5): File đã đổi, Kiểm chứng, Lưu ý, REPORT — Workflow linh hoạt: gộp gate, quick đủ bước, lộ trình động, Đã làm được gì

### Community 178 - "Report — Siết QC và vòng fix cho lane quick"
Cohesion: 0.33
Nodes (5): Commit, Giới hạn còn lại, Kết quả QC, Report — Siết QC và vòng fix cho lane quick, Đã làm

### Community 179 - "REQUEST — Hook = remind, bỏ skill tdq-approve, instruction/skills đủ chi tiết cho model yếu (7B)"
Cohesion: 0.33
...
### Community 180 - "REQUEST — Kiểm kê & tận dụng skill phụ trợ"
Cohesion: 0.33
...
### Community 181 - "requests/2026-07-31-hybrid-deep-search.md"
Cohesion: 0.33
...
### Community 182 - "REQUEST — Bump version + làm lại bản export đầy đủ hơn"
Cohesion: 0.33
...
### Community 183 - "Request — tối ưu token/time workflow (vòng 2)"
Cohesion: 0.33
...
### Community 184 - "REQUEST — Siết QC và vòng fix cho lane quick"
Cohesion: 0.33
...
### Community 185 - "RESEARCH — Instruction/skills đủ chắc để model yếu đi đúng workflow"
Cohesion: 0.33
...
### Community 186 - "RESEARCH — Tối ưu plugin user-level + lazy-load"
Cohesion: 0.33
...
### Community 187 - "Research — 2026-07-31-hybrid-deep-search"
Cohesion: 0.33
...
### Community 188 - "Research — 2026-08-03-skill-vao-goi-external"
Cohesion: 0.33
...
### Community 207 - "Questions: 2026-08-04-export-claude-setup"
Cohesion: 0.40
...
### Community 212 - "REQUEST — Tối ưu bộ plugin user-level theo ranking + lazy-load"
Cohesion: 0.40
...
### Community 213 - "REQUEST — Search agent dùng agy cho advanced search, tích hợp TDQ workflow"
Cohesion: 0.40
...
### Community 214 - "REQUEST — Thực thi 5 task P0 của đề xuất tối ưu token"
Cohesion: 0.40
Nodes (4): Chỗ chưa rõ (cần hỏi), Cách hiểu đầu tiên, Nguyên văn yêu cầu, REQUEST — Thực thi 5 task P0 của đề xuất tối ưu token

### Community 215 - "REQUEST — Tối ưu thời gian + token cho TDQ workflow"
Cohesion: 0.40
...
### Community 216 - "Request: Làm TDQ workflow linh hoạt & bớt ma sát"
Cohesion: 0.40
...
### Community 220 - "Request: giảm over-engineer & over-test cho bộ workflow"
Cohesion: 0.40
Nodes (4): Chỗ chưa rõ (cần interview), Hiểu ban đầu, Nguyên văn, Request: giảm over-engineer & over-test cho bộ workflow

### Community 221 - "Research — 2026-07-31-audit-full-workflow"
Cohesion: 0.40
...
### Community 222 - "RESEARCH — 2026-08-02-tdq-default-cleanup"
Cohesion: 0.40
...
### Community 223 - "2.3 Thiết kế state file"
Cohesion: 0.40
...
### Community 224 - "Kịch bản đo carry-cost before/after"
Cohesion: 0.40
...
### Community 233 - "QC — Bump 0.7.0 + bộ export Claude Code"
Cohesion: 0.50
Nodes (3): Defect QC phát hiện, Kết luận, QC — Bump 0.7.0 + bộ export Claude Code

### Community 234 - "questions/2026-07-31-agy-search-agent.md"
Cohesion: 0.50
...
### Community 242 - "Hỏi–đáp — tối ưu token vòng 2"
Cohesion: 0.50
Nodes (3): Hỏi–đáp — tối ưu token vòng 2, Vòng 1 (00:52), Vòng 2 (01:10)

### Community 243 - "REQUEST — Mode giao việc cho agent ngoài (codex/antigravity) trong TDQ workflow"
Cohesion: 0.50
...
### Community 307 - "SPEC — Cắt token thừa trong TDQ workflow"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)

### Community 308 - "bash_gate.py"
Cohesion: 0.31
...
### Community 310 - "PLAN — Cắt token thừa trong TDQ workflow"
Cohesion: 0.20
...
### Community 311 - "QuickQcApproveCliTest"
Cohesion: 0.22
...
### Community 313 - "REPORT — Cắt token thừa trong TDQ workflow"
Cohesion: 0.40
Nodes (4): Cần biết, Kiểm chứng, REPORT — Cắt token thừa trong TDQ workflow, Đã làm

### Community 314 - "TDQ Build — Implement → QC → Report"
Cohesion: 0.40
