...
## Corpus Check
- 433 files · ~530,200 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3810 nodes · 4840 edges · 375 communities (321 shown, 54 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4ce02ea1`
...
## Communities (375 total, 54 thin omitted)
...
### Community 1 - "test_token_audit.py"
Cohesion: 0.10
...
### Community 6 - "_common.py"
Cohesion: 0.06
Nodes (56): _check_signal_mismatch(), _clean(), _latest_signal(), main(), Dòng kind="signal" GẦN NHẤT khớp target (duyệt ngược sổ turn)., already_reminded(), approve_hint(), block() (+48 more)
...
Cohesion: 0.05
Nodes (37): 0.10.0 — 2026-08-09, 0.11.0 — 2026-08-09, 0.11.1 — 2026-08-09, 0.11.2 — 2026-08-09, 0.11.3 — 2026-08-12, 0.1.0 — 2026-07-27, 0.1.4 — 2026-07-28, 0.1.6 — 2026-07-28 (+29 more)
...
### Community 20 - "test_check_canvas_layout.py"
Cohesion: 0.23
...
### Community 31 - "QUICK — Siết luật tick checkbox cho lane quick"
Cohesion: 0.25
...
### Community 35 - "Spec — tối ưu token/time workflow (vòng 2)"
Cohesion: 0.12
...
### Community 36 - "Working log — 2026-07-27"
Cohesion: 0.12
...
### Community 38 - "TestProjectRootResolution"
Cohesion: 0.18
...
### Community 39 - "test_canvas_draw.py"
Cohesion: 0.18
...
### Community 40 - "test_prompt_context.py"
Cohesion: 0.21
...
### Community 44 - "test_agent_frontmatter.py"
Cohesion: 0.21
...
### Community 45 - "test_claude_export.py"
Cohesion: 0.12
...
### Community 47 - "helper.py"
Cohesion: 0.11
Nodes (19): decision(), load_fixture(), Shared test utilities: run hook scripts as subprocesses with stdin JSON., Parse PreToolUse hook stdout -> (permissionDecision, additionalContext).      0., run_hook(), write_file(), B3 — bash_gate.py: NHẮC (allow + additionalContext) về quy ước git và state.json, session_start.py + prompt_context.py (0.3.0) — bơm context theo state. (+11 more)

### Community 48 - "PLAN — Kiểm kê & tận dụng skill phụ trợ (0.3.3)"
Cohesion: 0.13
...
### Community 49 - "PLAN — Giảm over-engineer & over-test cho TDQ workflow"
Cohesion: 0.13
...
### Community 50 - "Working log 2026-07-29"
Cohesion: 0.13
...
### Community 52 - "tdq-conventions/SKILL.md"
Cohesion: 0.17
...
### Community 56 - "PLAN — TDQ 0.3.0 (instruction-hardening-7b)"
Cohesion: 0.14
...
### Community 59 - "Working log — 2026-08-12"
Cohesion: 0.12
Nodes (16): 12:08 — Mở intake request hoàn thiện product document trên Excalidraw, 12:11 — Phase analyze: kiểm kê năng lực, đọc code, research, mở vòng interview 1, 12:14 — Đóng interview, viết spec 13 chương, 12:18 — User duyệt spec, viết plan 6 phase / 22 task, 12:32 — P2 xong: 5 khối cũ đã về đúng chương 2/5/7/9/10, 12:41 — T3.1: vẽ Ch.1 Tổng quan sản phẩm, 12:52 — P4→P6 hoàn tất: 13 chương + mục lục, export ra docs/diagrams/, 12:58 — Mở request mới: đổi khổ tài liệu sang bề ngang A4 dọc (+8 more)

### Community 60 - "canvas_move_block.py"
Cohesion: 0.29
...
### Community 61 - "Brief — Commit + bump version, nhân tiện thử hàng rào tick"
Cohesion: 0.33
...
### Community 63 - "PLAN — Bump 0.7.0 + bộ export Claude Code chạy bằng một lệnh"
Cohesion: 0.15
...
### Community 64 - "PLAN — Tối ưu token/time workflow (vòng 2)"
Cohesion: 0.15
...
### Community 65 - "PLAN — Hoàn thiện product document trên Excalidraw"
Cohesion: 0.15
...
### Community 66 - "QC — giảm over-engineer workflow TDQ"
Cohesion: 0.15
...
### Community 67 - "Working log 2026-08-08"
Cohesion: 0.15
...
### Community 69 - "Brief — Siết luật tick checkbox cho lane quick"
Cohesion: 0.33
...
### Community 76 - "QUICK — Commit phần siết tick + bump 0.11.3"
Cohesion: 0.40
Nodes (4): Definition of Done, Phạm vi, QUICK — Commit phần siết tick + bump 0.11.3, Task
...
### Community 79 - "Lane quick — chi tiết"
Cohesion: 0.40
Nodes (5): Khuôn mini-spec/plan (≤ 40 dòng), Lane quick — chi tiết, Luật tick — `[ ]` · `[~]` · `[x]`, QC ở quick, Vòng fix

### Community 81 - "Quy tắc làm việc cho Claude"
Cohesion: 0.18
...
### Community 114 - "Knowledge — 2026-08-03-check-external-assign-flow"
Cohesion: 0.20
...
### Community 115 - "KNOWLEDGE — Bump version + export đầy đủ hơn"
Cohesion: 0.20
...
### Community 116 - "Knowledge — 2026-08-05-clone-setting-codex"
Cohesion: 0.20
...
### Community 117 - "KNOWLEDGE — Brainstorm + spec triển khai P0+P1 tối ưu workflow & user-level Claude Code"
Cohesion: 0.20
...
### Community 118 - "PLAN — Vá điểm mù verify-by-effect (0.3.1)"
Cohesion: 0.20
...
### Community 119 - "PLAN — Đổi thiết kế mode external: giao cả plan 1 lần + phase + verify 3 tầng"
Cohesion: 0.20
...
### Community 120 - "PLAN — Đưa skill vào gói external (hybrid 3 nhánh)"
Cohesion: 0.20
...
### Community 121 - "PLAN — Cắt token thừa trong TDQ workflow"
Cohesion: 0.20
...
### Community 122 - "Mini-spec/plan — 2026-08-09-sua-mo-ta-skill-inventory (lane quick)"
Cohesion: 0.20
...
### Community 123 - "PLAN — Đổi tài liệu sản phẩm sang khổ A4 dọc (bề ngang 1240px)"
Cohesion: 0.20
...
### Community 124 - "Vòng 1 (2026-08-05 13:35)"
Cohesion: 0.20
...
### Community 125 - "RESEARCH — Tối ưu token/time cho TDQ workflow"
Cohesion: 0.20
...
### Community 126 - "Research: clone-setting-to-codex — cấu trúc/khả năng cấu hình thật của Codex CLI (2026)"
Cohesion: 0.20
...
### Community 127 - "Research: Tối ưu token vòng 2 — biện pháp lâu dài cho agentic workflow"
Cohesion: 0.20
...
### Community 128 - "SPEC — Kiểm kê & tận dụng skill phụ trợ (tdq-workflow 0.3.3)"
Cohesion: 0.20
...
### Community 129 - "SPEC — Mode implement "external": giao task cho Codex/Antigravity qua worktree"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 130 - "SPEC — Tối ưu bộ plugin user-level: tier hoá, lazy-load, viết lại §10 (v1.0)"
Cohesion: 0.20
...
### Community 131 - "SPEC — Search agent "deep search" dùng agy CLI, tích hợp TDQ workflow"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 132 - "SPEC — Audit tổng thể TDQ workflow 0.6.0 (conflict, edge case, robustness model thấp)"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 133 - "SPEC — Hybrid deep search: Claude scout ∥ agy tổng quát → agy đào sâu"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 134 - "SPEC — Đổi thiết kế mode external: giao cả plan 1 lần + fix loop"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 135 - "SPEC — Bộ công cụ export cấu hình Claude Code sang máy khác"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 136 - "SPEC — TDQ workflow linh hoạt & bớt ma sát"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 137 - "tdq-intake/SKILL.md"
Cohesion: 0.24
Nodes (6): Phần B — Phân tích (phase `analyze`, chỉ lane full), Ghi lại, Hỏi cái gì, Hỏi thế nào, Khi nào dừng, Vòng interview

### Community 138 - "PlanTickStateTest"
Cohesion: 0.17
...
### Community 140 - "{{BUNDLE_NAME}} — Claude Code setup export"
Cohesion: 0.22
...
### Community 142 - "Plan — TDQWorkflow Plugin v0.1"
Cohesion: 0.22
...
### Community 144 - "KNOWLEDGE — external-agent-mode"
Cohesion: 0.22
...
### Community 145 - "Knowledge — 2026-08-04-approval-gate-bug"
Cohesion: 0.22
...
### Community 146 - "KNOWLEDGE — Tối ưu token/time cho TDQ workflow"
Cohesion: 0.22
...
### Community 147 - "Knowledge — 2026-08-04-workflow-linh-hoat"
Cohesion: 0.22
...
### Community 148 - "Knowledge — 2026-08-05-full-claude-export"
Cohesion: 0.22
...
### Community 149 - "KNOWLEDGE — Siết QC và vòng fix cho lane quick"
Cohesion: 0.22
...
### Community 150 - "Knowledge — 2026-08-08-giam-over-engineer-workflow"
Cohesion: 0.22
...
### Community 151 - "PLAN — Sửa lỗi approval-gate (nhắc nhở khi duyệt sai)"
Cohesion: 0.22
...
### Community 152 - "PLAN — Bộ công cụ export cấu hình Claude Code sang máy khác"
Cohesion: 0.22
...
### Community 153 - "PLAN — Đề xuất tối ưu time/token cho TDQ workflow"
Cohesion: 0.22
...
### Community 154 - "Mini-spec/plan — 2026-08-09-trigger-tieng-viet (lane quick)"
Cohesion: 0.22
...
### Community 155 - "REPORT — Instruction hardening cho model yếu (tdq-workflow 0.3.0)"
Cohesion: 0.22
...
### Community 156 - "REPORT — Audit toàn diện tdq-workflow 0.6.0"
Cohesion: 0.22
...
### Community 157 - "REPORT — Đổi thiết kế mode external: giao cả plan / theo phase"
Cohesion: 0.22
...
### Community 158 - "REPORT — Đưa skill vào gói external (hybrid 3 nhánh)"
Cohesion: 0.22
...
### Community 159 - "REPORT — Sửa lỗi approval-gate (nhắc nhở khi duyệt sai)"
Cohesion: 0.22
...
### Community 160 - "REPORT — Bộ công cụ export cấu hình Claude Code sang máy khác"
Cohesion: 0.22
...
### Community 161 - "Working log 2026-08-07"
Cohesion: 0.22
...
### Community 162 - "tdq-workflow — Plugin Claude Code"
Cohesion: 0.22
...
### Community 167 - "QuickQcApproveCliTest"
Cohesion: 0.22
...
### Community 169 - "Hướng dẫn tự cài tdq-workflow ở user-level VÀ project-level (thủ công)"
Cohesion: 0.25
...
### Community 170 - "2026-08-09-sua-mo-ta-skill-inventory"
Cohesion: 0.25
Nodes (7): 2026-08-09-sua-mo-ta-skill-inventory, Chỗ chưa rõ, Hiểu & kiến thức, Hỏi đáp, Mục tiêu, Nguyên văn, Phạm vi đoán

### Community 171 - "KNOWLEDGE — Search agent dùng agy cho advanced search (2026-07-31)"
Cohesion: 0.25
...
### Community 172 - "Knowledge — 2026-07-31-hybrid-deep-search"
Cohesion: 0.25
...
### Community 173 - "KNOWLEDGE — 2026-08-02-tdq-default-cleanup"
Cohesion: 0.25
...
### Community 174 - "PLAN — Vá chặn oan do vân tay repo (0.3.2)"
Cohesion: 0.25
...
### Community 175 - "PLAN — Mode implement "external" (Codex/Antigravity qua worktree) — HOÀN THÀNH (mode main, 2026-07-30 23:10; Q9 PENDING chờ user cài plugin codex)"
Cohesion: 0.25
...
### Community 176 - "PLAN — Tối ưu bộ plugin user-level: tier hoá + lazy-load (HOÀN THÀNH — QC PASS 9/9, 14:58)"
Cohesion: 0.25
...
### Community 177 - "PLAN — Audit toàn bộ workflow TDQ, đề xuất tối ưu token/thời gian (vòng 3)"
Cohesion: 0.25
...
### Community 178 - "Fix lỗi import webm alpha vào Unity 6.3 (Mac)"
Cohesion: 0.25
...
### Community 197 - "REPORT — Vá chặn oan do vân tay repo (tdq-workflow 0.3.2)"
Cohesion: 0.29
Nodes (6): Còn lại, Kết quả QC, REPORT — Vá chặn oan do vân tay repo (tdq-workflow 0.3.2), Vấn đề, Đã làm gì, Đầu ra

### Community 198 - "REPORT — Tối ưu bộ plugin user-level: tier hoá + lazy-load"
Cohesion: 0.29
...
### Community 199 - "Request: Claude tự quyết implement mode, không hỏi user"
Cohesion: 0.29
...
### Community 200 - "Request: state phải luôn nằm ở project root (chống "state bóng")"
Cohesion: 0.29
...
### Community 201 - "RESEARCH — Search agent dùng agy (2026-07-31)"
Cohesion: 0.29
...
### Community 202 - "Research — 2026-08-04-approval-gate-bug"
Cohesion: 0.29
...
### Community 203 - "Research: Giảm chi phí token/thời gian dài hạn cho agentic coding workflow"
Cohesion: 0.29
...
### Community 204 - "RESEARCH — Bump version + export đầy đủ hơn"
Cohesion: 0.29
...
### Community 205 - "Research: Cấu trúc documentation đầy đủ cho developer tool (CLI plugin)"
Cohesion: 0.29
...
### Community 206 - "Brief deep search — LLM local tham số thấp làm engine code-agent (2026-07-31)"
Cohesion: 0.29
...
### Community 209 - "KNOWLEDGE — instruction-hardening-7b (chốt trước khi viết spec)"
Cohesion: 0.33
...
### Community 210 - "KNOWLEDGE — Tối ưu plugin user-level + lazy-load"
Cohesion: 0.33
...
### Community 211 - "MINI-PLAN — Thực thi 5 task P0 tối ưu token"
Cohesion: 0.33
Nodes (5): Chốt từ interview, MINI-PLAN — Thực thi 5 task P0 tối ưu token, Rủi ro, Task, Validate cuối

### Community 212 - "Xóa nền video hiệu ứng → WebM VP8 alpha cho Unity"
Cohesion: 0.33
Nodes (5): DoD, Phạm vi, QC, Task, Xóa nền video hiệu ứng → WebM VP8 alpha cho Unity

### Community 213 - "QC — Kiểm kê & tận dụng skill phụ trợ (0.3.3)"
Cohesion: 0.33
...
### Community 214 - "QC — Mode implement "external" (Codex/Antigravity qua worktree)"
Cohesion: 0.33
...
### Community 215 - "QC — TDQ workflow là default tuyệt đối + bỏ mục superpower"
Cohesion: 0.33
...
### Community 216 - "QUESTIONS — Siết QC và vòng fix cho lane quick"
Cohesion: 0.33
...
### Community 217 - "Vòng 1 — 2026-08-08 21:5x"
Cohesion: 0.33
...
### Community 218 - "REPORT — Mode implement "external" (Codex/Antigravity qua worktree)"
Cohesion: 0.33
...
### Community 219 - "Report — Hybrid deep search 2 phase (tdq-workflow 0.6.0)"
Cohesion: 0.33
...
### Community 225 - "REQUEST — Kiểm kê & tận dụng skill phụ trợ"
Cohesion: 0.33
...
### Community 226 - "requests/2026-07-31-hybrid-deep-search.md"
Cohesion: 0.33
...
### Community 227 - "REQUEST — Bump version + làm lại bản export đầy đủ hơn"
Cohesion: 0.33
...
### Community 228 - "Request: clone-setting-codex"
Cohesion: 0.33
...
### Community 229 - "Request — tối ưu token/time workflow (vòng 2)"
Cohesion: 0.33
...
### Community 230 - "REQUEST — Siết QC và vòng fix cho lane quick"
Cohesion: 0.33
...
### Community 231 - "RESEARCH — Instruction/skills đủ chắc để model yếu đi đúng workflow"
Cohesion: 0.33
...
### Community 232 - "RESEARCH — Tối ưu plugin user-level + lazy-load"
Cohesion: 0.33
...
### Community 233 - "Research — 2026-07-31-hybrid-deep-search"
Cohesion: 0.33
...
### Community 234 - "Research — 2026-08-03-skill-vao-goi-external"
Cohesion: 0.33
...
### Community 236 - "Brief: phiên bản Python 3 mới nhất"
Cohesion: 0.33
Nodes (5): Brief: phiên bản Python 3 mới nhất, Câu hỏi, Dữ kiện đã có, Ngữ cảnh, Tiêu chí rank

### Community 237 - "Brief: phiên bản npm mới nhất của 2 package"
Cohesion: 0.33
Nodes (5): Brief: phiên bản npm mới nhất của 2 package, Câu hỏi, Dữ kiện đã có, Ngữ cảnh, Tiêu chí rank

### Community 238 - "Brief: phiên bản Python 3 mới nhất"
Cohesion: 0.33
Nodes (5): Brief: phiên bản Python 3 mới nhất, Câu hỏi, Dữ kiện đã có, Ngữ cảnh, Tiêu chí rank

### Community 239 - "BRIEF — Vector database chạy local cho RAG (2026)"
Cohesion: 0.33
...
### Community 241 - "Brief — clone-setting-codex (phase 2 đào sâu)"
Cohesion: 0.33
Nodes (5): Brief — clone-setting-codex (phase 2 đào sâu), Bối cảnh, Hướng từ phase 1 (route đã chốt cho phase 2), Luật evidence-only, Yêu cầu output

### Community 242 - "Phase `no_state` / `analyze` / lane quick — Intake"
Cohesion: 0.33
...
### Community 261 - "Questions: 2026-08-04-export-claude-setup"
Cohesion: 0.40
...
### Community 268 - "REQUEST — Tối ưu bộ plugin user-level theo ranking + lazy-load"
Cohesion: 0.40
...
### Community 269 - "REQUEST — Search agent dùng agy cho advanced search, tích hợp TDQ workflow"
Cohesion: 0.40
...
### Community 270 - "REQUEST — Thực thi 5 task P0 của đề xuất tối ưu token"
Cohesion: 0.40
Nodes (4): Chỗ chưa rõ (cần hỏi), Cách hiểu đầu tiên, Nguyên văn yêu cầu, REQUEST — Thực thi 5 task P0 của đề xuất tối ưu token

### Community 271 - "REQUEST — Tối ưu thời gian + token cho TDQ workflow"
Cohesion: 0.40
...
### Community 272 - "Request: Làm TDQ workflow linh hoạt & bớt ma sát"
Cohesion: 0.40
...
### Community 276 - "Request: giảm over-engineer & over-test cho bộ workflow"
Cohesion: 0.40
Nodes (4): Chỗ chưa rõ (cần interview), Hiểu ban đầu, Nguyên văn, Request: giảm over-engineer & over-test cho bộ workflow

### Community 277 - "Research — 2026-07-31-audit-full-workflow"
Cohesion: 0.40
...
### Community 278 - "RESEARCH — 2026-08-02-tdq-default-cleanup"
Cohesion: 0.40
...
### Community 279 - "2.3 Thiết kế state file"
Cohesion: 0.40
...
### Community 280 - "portable/ — dùng TDQ workflow ngoài Claude Code"
Cohesion: 0.40
...
### Community 281 - "Phase `implement` → `qc` → `report`"
Cohesion: 0.40
...
### Community 287 - "Kịch bản đo carry-cost before/after"
Cohesion: 0.40
...
### Community 293 - "QC — Smoke e2e (E1) — 2026-07-27"
Cohesion: 0.50
Nodes (3): 1. Chain test 2 lane (hook thật, chạy subprocess), 2. Headless CLI thật (`claude -p --plugin-dir .`), QC — Smoke e2e (E1) — 2026-07-27

### Community 294 - "brief/2026-08-11-fix-loi-import-webm-unity.md"
Cohesion: 0.50
Nodes (3): Hiểu & kiến thức, Hỏi đáp, Nguyên văn

### Community 295 - "2026-08-11-tdq-project-codex.md"
Cohesion: 0.50
Nodes (3): Hiểu & kiến thức, Hỏi đáp, Nguyên văn

### Community 296 - "QC — 2026-08-03-skill-vao-goi-external"
Cohesion: 0.50
Nodes (3): Ghi chú, QC — 2026-08-03-skill-vao-goi-external, Đầu ra §2 (9/9 tồn tại)

### Community 297 - "QC — workflow linh hoạt (gộp gate, lane quick đủ bước, lộ trình động)"
Cohesion: 0.50
Nodes (3): Ghi chú, Kết quả, QC — workflow linh hoạt (gộp gate, lane quick đủ bước, lộ trình động)

### Community 298 - "QC — Audit toàn bộ workflow TDQ, đề xuất tối ưu token/thời gian (vòng 3)"
Cohesion: 0.50
...
### Community 303 - "questions/2026-07-31-agy-search-agent.md"
Cohesion: 0.50
...
### Community 311 - "Câu hỏi — 2026-08-05-full-claude-export"
Cohesion: 0.50
...
### Community 312 - "Hỏi–đáp — tối ưu token vòng 2"
Cohesion: 0.50
Nodes (3): Hỏi–đáp — tối ưu token vòng 2, Vòng 1 (00:52), Vòng 2 (01:10)

### Community 313 - "REQUEST — Mode giao việc cho agent ngoài (codex/antigravity) trong TDQ workflow"
Cohesion: 0.50
...
### Community 326 - "TDQ STATE (tự sinh — không sửa tay)"
Cohesion: 0.50
Nodes (3): TDQ STATE (tự sinh — không sửa tay), Việc tiếp theo, Đang ở đâu

### Community 327 - "Ghi nhận duyệt"
Cohesion: 0.50
...
- **Why does `today_log_rel()` connect `tdq_state.py` to `_common.py`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `run_state_cli()` connect `run_state_cli` to `StateFileTest`, `QuickQcApproveCliTest`, `_common.py`, `helper.py`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **What connects `0.11.3 — 2026-08-12`, `0.11.2 — 2026-08-09`, `0.11.1 — 2026-08-09` to the rest of the system?**
