# Graph Report - TDQWorkflow  (2026-08-08)

## Corpus Check
- 377 files · ~318,092 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3119 nodes · 3898 edges · 306 communities (255 shown, 51 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `de762215`
...
2. `TestState` - 30 edges
3. `Working Log — 2026-08-04` - 30 edges
4. `write_state()` - 30 edges
...
9. `TestPromptContext` - 22 edges
10. `Working log — 2026-07-28` - 22 edges
...
## Communities (306 total, 51 thin omitted)
...
### Community 5 - ".write"
Cohesion: 0.08
Nodes (17): DocLintTest, LintBase, MissingPathTest, PairTest, R8Test, P5 — mỗi rule của scripts/doc_lint.py có 1 fixture bẩn + 1 fixture sạch.  Lint l, Cửa thoát chuẩn phải im được R5.          Bug cũ: rule_r5 gom dòng liền nhau thà, Miễn trừ chỉ cho đúng đoạn ngay dưới, không miễn cả file. (+9 more)
...
### Community 8 - "PLAN — Giảm over-engineer & over-test cho TDQ workflow"
Cohesion: 0.14
Nodes (13): Definition of Done, Năng lực → task, P1 — Sửa `doc_lint` (D7), P2 — Xoá nhánh external và deep search (D3), P3 — Xoá `portable/` (D4), P4 — Gộp output thành `brief/` (D5), P5 — Tầng `nhỏ` và QC bám DoD (D1, D2), P6 — Rút gọn skill nặng (D6) (+5 more)
...
### Community 10 - "SPEC — Giảm over-engineer & over-test cho TDQ workflow"
Cohesion: 0.18
...
### Community 11 - "TestPromptContext"
Cohesion: 0.09
...
### Community 12 - "Working log 2026-08-05"
Cohesion: 0.05
...
### Community 20 - "Quy tắc làm việc cho Claude"
Cohesion: 0.20
...
### Community 24 - "Working log 2026-08-08"
Cohesion: 0.20
Nodes (9): 15:36 — đóng sổ request 2026-08-07-siet-qc-lane-quick (commit 704ac3f), 21:53, 21:59, 22:13, 22:19, 22:40, 22:41, 22:42 (+1 more)
...
### Community 26 - "Knowledge — 2026-08-08-giam-over-engineer-workflow"
Cohesion: 0.22
...
### Community 28 - "Working log — 2026-07-30"
Cohesion: 0.08
...
Cohesion: 0.08
Nodes (14): QuickQcApprovalHintTest, QuickQcApproveCliTest, QuickQcDocTest, QuickQcPhasesDocTest, QuickQcPhaseTableTest, Lane quick: QC 3 hạng mục (mặc định BẬT) + vòng fix bắt buộc trần 3 vòng.  Khoá, Quyết định 9: bỏ QC vẫn phải để lại nguyên văn câu user., Phải từ chối bằng thông báo NÊU TÊN cờ, không phải bằng USAGE chung. (+6 more)

### Community 33 - "Changelog"
Cohesion: 0.06
Nodes (30): 0.1.0 — 2026-07-27, 0.1.4 — 2026-07-28, 0.1.6 — 2026-07-28, 0.2.0 — 2026-07-28, 0.3.0 — 2026-07-29, 0.3.1 — 2026-07-29, 0.3.2 — 2026-07-29, 0.3.3 — 2026-07-29 (+22 more)
...
### Community 37 - "Vòng 1 — 2026-08-08 21:5x"
Cohesion: 0.33
...
### Community 38 - "Request: giảm over-engineer & over-test cho bộ workflow"
Cohesion: 0.40
...
### Community 48 - "Kiến thức chốt — audit tối ưu token/time workflow (vòng 3)"
Cohesion: 0.12
...
### Community 49 - "SPEC — Vá điểm mù của verify-by-effect (sổ turn chỉ thấy Edit/Write)"
Cohesion: 0.12
...
### Community 50 - "Working log — 2026-08-02"
Cohesion: 0.12
...
### Community 51 - "skill_inventory.py"
Cohesion: 0.19
...
### Community 52 - "test_claude_export.py"
Cohesion: 0.12
...
### Community 53 - "PLAN — Siết QC và vòng fix cho lane quick"
Cohesion: 0.18
...
### Community 55 - "PLAN — Kiểm kê & tận dụng skill phụ trợ (0.3.3)"
Cohesion: 0.13
...
### Community 56 - "Working log — 2026-07-27"
Cohesion: 0.13
...
### Community 57 - "Working log 2026-07-29"
Cohesion: 0.13
...
### Community 58 - "run_hook"
Cohesion: 0.31
Nodes (3): run_hook(), P2/T2.12 — hook không bao giờ làm hỏng tool call (spec §4.7).  Mọi hook × mọi tr, ResilienceTest

### Community 59 - "helper.py"
Cohesion: 0.22
Nodes (11): decision(), load_fixture(), Shared test utilities: run hook scripts as subprocesses with stdin JSON., Parse PreToolUse hook stdout -> (permissionDecision, additionalContext).      0., read_state(), write_file(), ChainBase, E1 — chuỗi end-to-end cả hai lane theo mô hình 0.3.0.  User duyệt bằng chat → Cl (+3 more)

### Community 61 - "PLAN — Search agent "deep search" dùng agy CLI, tích hợp TDQ workflow"
Cohesion: 0.14
...
### Community 62 - "PLAN — Triển khai 16 đề xuất P0+P1 tối ưu workflow TDQ & user-level Claude Code"
Cohesion: 0.14
...
### Community 73 - "TestProjectRootResolution"
Cohesion: 0.17
...
### Community 75 - "Đợt 1 (21:13) — khả thi tổng quát"
Cohesion: 0.17
...
### Community 77 - "tdq-intake/SKILL.md"
Cohesion: 0.24
Nodes (5): Phần B — Phân tích (phase `analyze`, chỉ lane full), Bảng quyết, Chọn lane: quick hay full, Khuôn câu hỏi (copy được), Luồng mỗi lane

### Community 78 - "TDQ Conventions"
Cohesion: 0.17
...
### Community 82 - "_read"
Cohesion: 0.06
Nodes (17): OptionMotDongTest, QuickLaneThinkingStepsTest, Contract test cho skill docs.  Đối tượng: luật nhãn (mcp) của tdq-plan, lane qui, Request toi-uu-token-vong-2 (P4) — 8 luật vòng 2 phải nằm trong skill,     không, Request format-cau-hoi-interview — mọi câu hỏi có option phải xuống dòng     từn, T4.4 — tdq-plan SKILL.md + plan-template.md: luật bắt buộc nhãn `(mcp)`     theo, P4 — lane quick giữ đủ bước tư duy (search + interview) và gộp tài liệu     thàn, Request thuc-thi-p0-token — 5 luật P0 cắt carry-cost phải nằm trong skill     (k (+9 more)
...
### Community 88 - "QC — 2026-07-31-audit-full-workflow"
Cohesion: 0.18
...
### Community 89 - "SPEC — TDQ 0.3.0: tuân thủ kiểm được, state đọc được, workflow đủ rõ cho mọi model"
Cohesion: 0.18
...
### Community 91 - "SPEC — TDQ workflow là default tuyệt đối + bỏ mục superpower (mục 5 cũ)"
Cohesion: 0.18
...
### Community 92 - "SPEC — Đưa skill vào gói external (hybrid 3 nhánh)"
Cohesion: 0.18
...
### Community 93 - "SPEC — 2026-08-04-approval-gate-bug"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+2 more)

### Community 94 - "SPEC — Đề xuất tối ưu time/token cho TDQ workflow"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)

### Community 95 - "SPEC — Audit toàn bộ workflow TDQ, đề xuất tối ưu token/thời gian (vòng 3)"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)

### Community 96 - "SPEC — Bump 0.7.0 + bộ export Claude Code đầy đủ, chạy được bằng một lệnh"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)

### Community 97 - "SPEC — Triển khai 16 đề xuất P0+P1 tối ưu workflow TDQ & user-level Claude Code"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)
...
### Community 102 - "KNOWLEDGE — Brainstorm + spec triển khai P0+P1 tối ưu workflow & user-level Claude Code"
Cohesion: 0.20
...
### Community 103 - "PLAN — Vá điểm mù verify-by-effect (0.3.1)"
Cohesion: 0.20
...
### Community 104 - "PLAN — Đổi thiết kế mode external: giao cả plan 1 lần + phase + verify 3 tầng"
Cohesion: 0.20
...
### Community 105 - "PLAN — Đưa skill vào gói external (hybrid 3 nhánh)"
Cohesion: 0.20
...
### Community 106 - "Vòng 1 (2026-08-05 13:35)"
Cohesion: 0.20
...
### Community 107 - "RESEARCH — Tối ưu token/time cho TDQ workflow"
Cohesion: 0.20
...
### Community 108 - "Research: Tối ưu token vòng 2 — biện pháp lâu dài cho agentic workflow"
Cohesion: 0.20
...
### Community 109 - "SPEC — Kiểm kê & tận dụng skill phụ trợ (tdq-workflow 0.3.3)"
Cohesion: 0.20
...
### Community 110 - "SPEC — Mode implement "external": giao task cho Codex/Antigravity qua worktree"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 111 - "SPEC — Tối ưu bộ plugin user-level: tier hoá, lazy-load, viết lại §10 (v1.0)"
Cohesion: 0.20
...
### Community 112 - "SPEC — Search agent "deep search" dùng agy CLI, tích hợp TDQ workflow"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 113 - "SPEC — Audit tổng thể TDQ workflow 0.6.0 (conflict, edge case, robustness model thấp)"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 114 - "SPEC — Hybrid deep search: Claude scout ∥ agy tổng quát → agy đào sâu"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 115 - "SPEC — Đổi thiết kế mode external: giao cả plan 1 lần + fix loop"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 116 - "SPEC — Bộ công cụ export cấu hình Claude Code sang máy khác"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 117 - "SPEC — TDQ workflow linh hoạt & bớt ma sát"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 125 - "{{BUNDLE_NAME}} — Claude Code setup export"
Cohesion: 0.22
...
### Community 127 - "Plan — TDQWorkflow Plugin v0.1"
Cohesion: 0.22
...
### Community 132 - "PLAN — Sửa lỗi approval-gate (nhắc nhở khi duyệt sai)"
Cohesion: 0.22
...
### Community 133 - "PLAN — Bộ công cụ export cấu hình Claude Code sang máy khác"
Cohesion: 0.22
...
### Community 134 - "PLAN — Đề xuất tối ưu time/token cho TDQ workflow"
Cohesion: 0.22
...
### Community 135 - "REPORT — Instruction hardening cho model yếu (tdq-workflow 0.3.0)"
Cohesion: 0.22
...
### Community 136 - "REPORT — Audit toàn diện tdq-workflow 0.6.0"
Cohesion: 0.22
...
### Community 137 - "REPORT — Đổi thiết kế mode external: giao cả plan / theo phase"
Cohesion: 0.22
...
### Community 138 - "REPORT — Đưa skill vào gói external (hybrid 3 nhánh)"
Cohesion: 0.22
...
### Community 139 - "REPORT — Sửa lỗi approval-gate (nhắc nhở khi duyệt sai)"
Cohesion: 0.22
...
### Community 140 - "REPORT — Bộ công cụ export cấu hình Claude Code sang máy khác"
Cohesion: 0.22
...
### Community 143 - "tdq-workflow — Plugin Claude Code"
Cohesion: 0.22
...
### Community 149 - "KNOWLEDGE — Search agent dùng agy cho advanced search (2026-07-31)"
Cohesion: 0.25
...
### Community 150 - "Knowledge — 2026-07-31-hybrid-deep-search"
Cohesion: 0.25
...
### Community 151 - "KNOWLEDGE — 2026-08-02-tdq-default-cleanup"
Cohesion: 0.25
...
### Community 152 - "PLAN — Vá chặn oan do vân tay repo (0.3.2)"
Cohesion: 0.25
...
### Community 153 - "PLAN — Mode implement "external" (Codex/Antigravity qua worktree) — HOÀN THÀNH (mode main, 2026-07-30 23:10; Q9 PENDING chờ user cài plugin codex)"
Cohesion: 0.25
...
### Community 154 - "PLAN — Tối ưu bộ plugin user-level: tier hoá + lazy-load (HOÀN THÀNH — QC PASS 9/9, 14:58)"
Cohesion: 0.25
...
### Community 155 - "PLAN — Audit toàn bộ workflow TDQ, đề xuất tối ưu token/thời gian (vòng 3)"
Cohesion: 0.25
...
### Community 157 - "QC — Vá điểm mù verify-by-effect (0.3.1)"
Cohesion: 0.25
...
### Community 158 - "Vòng 1 (2026-08-05 03:2x) — đã hỏi, chờ trả lời"
Cohesion: 0.25
...
### Community 159 - "REPORT — Kiểm kê & tận dụng skill phụ trợ (tdq-workflow 0.3.3)"
Cohesion: 0.25
...
### Community 160 - "REPORT — Vá điểm mù verify-by-effect (tdq-workflow 0.3.1)"
Cohesion: 0.25
...
### Community 161 - "REPORT — Tối ưu time/token cho TDQ workflow"
Cohesion: 0.25
...
### Community 162 - "Research: 2026-08-04-export-claude-setup"
Cohesion: 0.25
...
### Community 163 - "Brief deep search — LLM local tham số thấp làm engine code-agent (2026-07-31)"
Cohesion: 0.25
...
### Community 164 - "Kiểm kê năng lực (bước B0)"
Cohesion: 0.25
...
### Community 169 - "INSTRUCTIONS — Dựng bundle export cấu hình Claude Code"
Cohesion: 0.29
...
### Community 170 - "Report — TDQWorkflow Plugin v0.1.0 — 2026-07-27"
Cohesion: 0.29
...
### Community 171 - "Knowledge — 2026-07-31-audit-full-workflow"
Cohesion: 0.29
...
### Community 172 - "Knowledge — 2026-08-03-skill-vao-goi-external"
Cohesion: 0.29
...
### Community 173 - "Knowledge: 2026-08-04-export-claude-setup"
Cohesion: 0.29
...
### Community 175 - "QC — Tối ưu plugin user-level: tier hoá + lazy-load"
Cohesion: 0.29
...
### Community 176 - "REPORT — Vá chặn oan do vân tay repo (tdq-workflow 0.3.2)"
Cohesion: 0.29
Nodes (6): Còn lại, Kết quả QC, REPORT — Vá chặn oan do vân tay repo (tdq-workflow 0.3.2), Vấn đề, Đã làm gì, Đầu ra

### Community 177 - "REPORT — Tối ưu bộ plugin user-level: tier hoá + lazy-load"
Cohesion: 0.29
...
### Community 178 - "Request: Claude tự quyết implement mode, không hỏi user"
Cohesion: 0.29
...
### Community 179 - "Request: state phải luôn nằm ở project root (chống "state bóng")"
Cohesion: 0.29
...
### Community 180 - "RESEARCH — Search agent dùng agy (2026-07-31)"
Cohesion: 0.29
...
### Community 181 - "Research — 2026-08-04-approval-gate-bug"
Cohesion: 0.29
...
### Community 182 - "Research: Giảm chi phí token/thời gian dài hạn cho agentic coding workflow"
Cohesion: 0.29
...
### Community 183 - "RESEARCH — Bump version + export đầy đủ hơn"
Cohesion: 0.29
...
### Community 184 - "Brief deep search — LLM local tham số thấp làm engine code-agent (2026-07-31)"
Cohesion: 0.29
...
### Community 194 - "KNOWLEDGE — instruction-hardening-7b (chốt trước khi viết spec)"
Cohesion: 0.33
...
### Community 195 - "KNOWLEDGE — Tối ưu plugin user-level + lazy-load"
Cohesion: 0.33
...
### Community 196 - "MINI-PLAN — Thực thi 5 task P0 tối ưu token"
Cohesion: 0.33
Nodes (5): Chốt từ interview, MINI-PLAN — Thực thi 5 task P0 tối ưu token, Rủi ro, Task, Validate cuối

### Community 197 - "QC — Kiểm kê & tận dụng skill phụ trợ (0.3.3)"
Cohesion: 0.33
...
### Community 198 - "QC — Mode implement "external" (Codex/Antigravity qua worktree)"
Cohesion: 0.33
...
### Community 199 - "QC — TDQ workflow là default tuyệt đối + bỏ mục superpower"
Cohesion: 0.33
...
### Community 200 - "REPORT — Mode implement "external" (Codex/Antigravity qua worktree)"
Cohesion: 0.33
...
### Community 201 - "Report — Hybrid deep search 2 phase (tdq-workflow 0.6.0)"
Cohesion: 0.33
...
### Community 202 - "REPORT — Workflow linh hoạt: gộp gate, quick đủ bước, lộ trình động"
Cohesion: 0.33
...
### Community 205 - "requests/2026-07-31-hybrid-deep-search.md"
Cohesion: 0.33
...
### Community 207 - "Request — tối ưu token/time workflow (vòng 2)"
Cohesion: 0.33
...
### Community 208 - "RESEARCH — Instruction/skills đủ chắc để model yếu đi đúng workflow"
Cohesion: 0.33
...
### Community 209 - "RESEARCH — Tối ưu plugin user-level + lazy-load"
Cohesion: 0.33
...
### Community 210 - "Research — 2026-07-31-hybrid-deep-search"
Cohesion: 0.33
...
### Community 211 - "Research — 2026-08-03-skill-vao-goi-external"
Cohesion: 0.33
...
### Community 212 - "Brief: phiên bản Python 3 mới nhất"
Cohesion: 0.33
Nodes (5): Brief: phiên bản Python 3 mới nhất, Câu hỏi, Dữ kiện đã có, Ngữ cảnh, Tiêu chí rank

### Community 213 - "Brief: phiên bản Python 3 mới nhất"
Cohesion: 0.33
Nodes (5): Brief: phiên bản Python 3 mới nhất, Câu hỏi, Dữ kiện đã có, Ngữ cảnh, Tiêu chí rank

### Community 214 - "Brief: phiên bản npm mới nhất của 2 package"
Cohesion: 0.33
...
### Community 216 - "BRIEF — Vector database chạy local cho RAG (2026)"
Cohesion: 0.33
Nodes (5): BRIEF — Vector database chạy local cho RAG (2026), Câu hỏi, Dữ kiện đã có, Ngữ cảnh, Tiêu chí rank

### Community 217 - "test_agent_digest_sync.py"
Cohesion: 0.50
Nodes (3): AgentDigestSyncTest, _find_threshold(), P5 (toi-uu-p0-p1-workflow) — ngưỡng digest "≤1.500 ký tự" phải đồng bộ giữa mọi

### Community 219 - "make_repo"
Cohesion: 0.33
...
### Community 233 - "Questions: 2026-08-04-export-claude-setup"
Cohesion: 0.40
...
### Community 238 - "REQUEST — Tối ưu bộ plugin user-level theo ranking + lazy-load"
Cohesion: 0.40
...
### Community 239 - "REQUEST — Search agent dùng agy cho advanced search, tích hợp TDQ workflow"
Cohesion: 0.40
...
### Community 240 - "REQUEST — Thực thi 5 task P0 của đề xuất tối ưu token"
Cohesion: 0.40
Nodes (4): Chỗ chưa rõ (cần hỏi), Cách hiểu đầu tiên, Nguyên văn yêu cầu, REQUEST — Thực thi 5 task P0 của đề xuất tối ưu token

### Community 241 - "REQUEST — Tối ưu thời gian + token cho TDQ workflow"
Cohesion: 0.40
...
### Community 242 - "Request: Làm TDQ workflow linh hoạt & bớt ma sát"
Cohesion: 0.40
...
### Community 246 - "Research — 2026-07-31-audit-full-workflow"
Cohesion: 0.40
...
### Community 247 - "RESEARCH — 2026-08-02-tdq-default-cleanup"
Cohesion: 0.40
...
### Community 248 - "2.3 Thiết kế state file"
Cohesion: 0.40
...
### Community 249 - "tdq-build/SKILL.md"
Cohesion: 0.14
...
### Community 250 - "SPEC — Siết QC và vòng fix cho lane quick"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)

### Community 251 - "Kịch bản đo carry-cost before/after"
Cohesion: 0.40
...
### Community 260 - "QC — Bump 0.7.0 + bộ export Claude Code"
Cohesion: 0.50
...
### Community 269 - "Hỏi–đáp — tối ưu token vòng 2"
Cohesion: 0.50
Nodes (3): Hỏi–đáp — tối ưu token vòng 2, Vòng 1 (00:52), Vòng 2 (01:10)

### Community 270 - "REQUEST — Mode giao việc cho agent ngoài (codex/antigravity) trong TDQ workflow"
Cohesion: 0.50
...
### Community 285 - "Định tuyến việc → plugin"
Cohesion: 0.50
Nodes (3): Bảng định tuyến, Giao thức dùng, Định tuyến việc → plugin

### Community 287 - "KNOWLEDGE — Siết QC và vòng fix cho lane quick"
Cohesion: 0.22
...
### Community 288 - "TDQ Intake — mở request & phân tích"
Cohesion: 0.50
...
### Community 289 - "tdq-plan/SKILL.md"
Cohesion: 0.29
Nodes (5): Dòng `Mode thực thi`, Khuôn plan, Kiểm trước khi trình, Các bước, TDQ Plan

### Community 290 - "tdq-spec/SKILL.md"
Cohesion: 0.29
Nodes (5): Checklist scope — trả lời được hết mới trình, Khuôn spec, Kiểm trước khi trình, Các bước, TDQ Spec

### Community 306 - "Working log 2026-08-07"
Cohesion: 0.22
...
### Community 307 - "Lane quick — chi tiết"
Cohesion: 0.50
Nodes (4): Khuôn mini-spec/plan (≤ 40 dòng), Lane quick — chi tiết, QC ở quick, Vòng fix

### Community 347 - "QUESTIONS — Siết QC và vòng fix cho lane quick"
Cohesion: 0.33
...
### Community 348 - "Report — Siết QC và vòng fix cho lane quick"
Cohesion: 0.33
Nodes (5): Commit, Giới hạn còn lại, Kết quả QC, Report — Siết QC và vòng fix cho lane quick, Đã làm

### Community 349 - "REQUEST — Siết QC và vòng fix cho lane quick"
Cohesion: 0.33
...
### Community 350 - "QC — Siết QC và vòng fix cho lane quick"
Cohesion: 0.40
Nodes (4): Ghi chú (không FAIL, đã báo trong report), Q8 — kiểm độc lập, QC — Siết QC và vòng fix cho lane quick, Vòng fix

## Knowledge Gaps
- **1441 isolated node(s):** `Pipeline`, `Cách hook điều khiển agent`, `Duyệt bằng chat thường`, `Cài đặt (chỉ trong repo/project)`, `Dùng hằng ngày` (+1436 more)
...
- **Why does `write_state()` connect `.stop` to `run_hook`, `helper.py`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `TestState` connect `TestState` to `.test_mode_external_bi_tu_choi`, `TestProjectRootResolution`, `.test_reapprove_refreshes_sha256_after_file_changed`, `.test_reapprove_unchanged_file_stays_idempotent`, `.test_approve_quick_moves_phase_to_implement`, `.test_row_age_ok_bad_ts_types`, `.test_init_set_reset_in_mot_dong_khong_json`, `.test_co_co_json_thi_in_lai_nguyen_state`?**
