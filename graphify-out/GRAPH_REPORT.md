...
## Corpus Check
- 481 files · ~566,253 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4225 nodes · 5196 edges · 426 communities (364 shown, 62 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5006e12`
...
2. `Working log — 2026-08-13` - 52 edges
...
## Communities (426 total, 62 thin omitted)
...
### Community 1 - ".stop"
Cohesion: 0.07
Nodes (25): stop_gate.py (0.3.0) — đối chiếu lời nhắc với hiệu ứng thật trong sổ turn.  Điểm, P3 (0.3.1) — hiệu ứng THẬT trên đĩa, không chỉ tin sổ turn.      Sổ turn chỉ ghi, Giả lập prompt_context: chụp trạng thái đĩa lúc mở turn., Bug gốc: log append bằng shell → không có `log_written` → chặn oan., Log hôm nay chưa tồn tại đầu turn, được tạo bằng shell trong turn., Có ảnh chụp nhưng log KHÔNG đổi → vẫn phải chặn., Không phải git repo → repo_sha None, nhưng chiều log vẫn vá được., Sửa repo hoàn toàn bằng shell (không `observe` nào) → phải chặn. (+17 more)

### Community 2 - "test_token_audit.py"
Cohesion: 0.10
...
### Community 5 - "Working log 2026-08-05"
Cohesion: 0.04
...
### Community 7 - "test_check_canvas_layout.py"
Cohesion: 0.23
...
### Community 12 - "SPEC — Yêu cầu mới ⇒ state được đồng bộ lại theo lane user chọn"
Cohesion: 0.05
...
Cohesion: 0.04
Nodes (52): 14:07 — Mở brief rà soát tick ở chế độ chuyên sâu, 14:20 — Interview xong, viết & trình spec vá tick chế độ chuyên sâu, 14:32 — Viết & trình plan vá tick chế độ chuyên sâu, 14:41, 14:43, 14:52 — Bump version & commit, 14:54, 15:00 — Mở request: ví dụ & hướng dẫn thân thiện cho câu hỏi khuôn A/B/C (+44 more)
...
Cohesion: 0.08
Nodes (23): decision(), load_fixture(), Shared test utilities: run hook scripts as subprocesses with stdin JSON., Parse PreToolUse hook stdout -> (permissionDecision, additionalContext).      0., run_hook(), write_file(), B3 — bash_gate.py: NHẮC (allow + additionalContext) về quy ước git và state.json, session_start.py + prompt_context.py (0.3.0) — bơm context theo state. (+15 more)
...
### Community 32 - "Working log — 2026-08-12"
Cohesion: 0.10
...
### Community 33 - "canvas_move_block.py"
Cohesion: 0.18
...
### Community 37 - "Working log — 2026-07-27"
Cohesion: 0.12
...
### Community 40 - "test_canvas_draw.py"
Cohesion: 0.18
...
### Community 41 - "PlanTickStateTest"
Cohesion: 0.17
...
### Community 44 - "SPEC — Vá điểm mù của verify-by-effect (sổ turn chỉ thấy Edit/Write)"
Cohesion: 0.12
...
### Community 45 - "Working log — 2026-08-02"
Cohesion: 0.12
...
### Community 48 - "test_lane_label.py"
Cohesion: 0.10
...
### Community 50 - "PLAN — Kiểm kê & tận dụng skill phụ trợ (0.3.3)"
Cohesion: 0.13
...
### Community 51 - "PLAN — Giảm over-engineer & over-test cho TDQ workflow"
Cohesion: 0.13
...
### Community 52 - "Working log 2026-07-29"
Cohesion: 0.13
...
### Community 57 - "PLAN — TDQ 0.3.0 (instruction-hardening-7b)"
Cohesion: 0.14
...
### Community 71 - "PLAN — Hybrid deep search 0.6.0 (scout ∥ agy tổng quát → agy đào sâu)"
Cohesion: 0.17
...
### Community 72 - "PLAN — Full claude export (multi-repo local dependency)"
Cohesion: 0.17
...
### Community 73 - "Đợt 1 (21:13) — khả thi tổng quát"
Cohesion: 0.17
...
### Community 110 - "SPEC — Lưu & nhúng ảnh đính kèm vào working log"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)

### Community 111 - "SPEC — Bịt 3 lỗ hổng tick checkbox ở chế độ chuyên sâu"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)

### Community 112 - "SPEC — Rút gọn UX câu hỏi chọn lane"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)

### Community 113 - "SPEC — Ví dụ & hướng dẫn thân thiện cho câu hỏi kiểu A/B/C"
Cohesion: 0.18
Nodes (10): 1. Mục tiêu & phạm vi, 1b. Lộ trình, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done (+2 more)

### Community 114 - "prompt_context.py"
Cohesion: 0.29
...
### Community 115 - "TDQ Workflow — bản portable (agent nào cũng chạy được)"
Cohesion: 0.18
...
### Community 116 - "tdq-intake/SKILL.md"
Cohesion: 0.24
...
### Community 121 - "Knowledge — 2026-08-03-check-external-assign-flow"
Cohesion: 0.20
...
### Community 122 - "KNOWLEDGE — Bump version + export đầy đủ hơn"
Cohesion: 0.20
...
### Community 123 - "Knowledge — 2026-08-05-clone-setting-codex"
Cohesion: 0.20
...
### Community 124 - "KNOWLEDGE — Brainstorm + spec triển khai P0+P1 tối ưu workflow & user-level Claude Code"
Cohesion: 0.20
...
### Community 125 - "PLAN — Vá điểm mù verify-by-effect (0.3.1)"
Cohesion: 0.20
...
### Community 126 - "PLAN — Đổi thiết kế mode external: giao cả plan 1 lần + phase + verify 3 tầng"
Cohesion: 0.20
...
### Community 127 - "PLAN — Đưa skill vào gói external (hybrid 3 nhánh)"
Cohesion: 0.20
...
### Community 128 - "PLAN — Cắt token thừa trong TDQ workflow"
Cohesion: 0.20
...
### Community 129 - "Mini-spec/plan — 2026-08-09-sua-mo-ta-skill-inventory (lane quick)"
Cohesion: 0.20
...
### Community 130 - "PLAN — Đổi nhãn lane: `chế độ nhanh (express)` / `chế độ chuyên sâu (deep)`"
Cohesion: 0.20
...
### Community 131 - "PLAN — Đổi tài liệu sản phẩm sang khổ A4 dọc (bề ngang 1240px)"
Cohesion: 0.20
...
### Community 132 - "Vòng 1 (2026-08-05 13:35)"
Cohesion: 0.20
...
### Community 133 - "RESEARCH — Tối ưu token/time cho TDQ workflow"
Cohesion: 0.20
...
### Community 134 - "Research: clone-setting-to-codex — cấu trúc/khả năng cấu hình thật của Codex CLI (2026)"
Cohesion: 0.20
...
### Community 135 - "Research: Tối ưu token vòng 2 — biện pháp lâu dài cho agentic workflow"
Cohesion: 0.20
...
### Community 136 - "SPEC — Kiểm kê & tận dụng skill phụ trợ (tdq-workflow 0.3.3)"
Cohesion: 0.20
...
### Community 137 - "SPEC — Mode implement "external": giao task cho Codex/Antigravity qua worktree"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 138 - "SPEC — Tối ưu bộ plugin user-level: tier hoá, lazy-load, viết lại §10 (v1.0)"
Cohesion: 0.20
...
### Community 139 - "SPEC — Search agent "deep search" dùng agy CLI, tích hợp TDQ workflow"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 140 - "SPEC — Audit tổng thể TDQ workflow 0.6.0 (conflict, edge case, robustness model thấp)"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 141 - "SPEC — Hybrid deep search: Claude scout ∥ agy tổng quát → agy đào sâu"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 142 - "SPEC — Đổi thiết kế mode external: giao cả plan 1 lần + fix loop"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 143 - "SPEC — Bộ công cụ export cấu hình Claude Code sang máy khác"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 144 - "SPEC — TDQ workflow linh hoạt & bớt ma sát"
Cohesion: 0.20
Nodes (9): 1. Mục tiêu & phạm vi, 2. Đầu ra cụ thể, 3. Cách tiếp cận & lý do, 3b. Năng lực & công cụ, 4. Yêu cầu bắt buộc, 5. Ràng buộc & rủi ro, 6. QC & Definition of Done, 7. Câu hỏi còn mở (+1 more)

### Community 145 - "SPEC — Đổi nhãn lane: `chế độ nhanh (express)` / `chế độ chuyên sâu (deep)`"
Cohesion: 0.20
...
### Community 146 - "{{BUNDLE_NAME}} — Claude Code setup export"
Cohesion: 0.22
...
### Community 148 - "Plan — TDQWorkflow Plugin v0.1"
Cohesion: 0.22
...
### Community 150 - "Brief — Lưu & nhúng ảnh đính kèm vào working log"
Cohesion: 0.22
...
### Community 151 - "Brief — Rút gọn UX câu hỏi chọn lane"
Cohesion: 0.22
...
### Community 153 - "KNOWLEDGE — external-agent-mode"
Cohesion: 0.22
...
### Community 154 - "Knowledge — 2026-08-04-approval-gate-bug"
Cohesion: 0.22
...
### Community 155 - "KNOWLEDGE — Tối ưu token/time cho TDQ workflow"
Cohesion: 0.22
...
### Community 156 - "Knowledge — 2026-08-04-workflow-linh-hoat"
Cohesion: 0.22
...
### Community 157 - "Knowledge — 2026-08-05-full-claude-export"
Cohesion: 0.22
...
### Community 158 - "KNOWLEDGE — Siết QC và vòng fix cho lane quick"
Cohesion: 0.22
...
### Community 159 - "Knowledge — 2026-08-08-giam-over-engineer-workflow"
Cohesion: 0.22
...
### Community 160 - "PLAN — Sửa lỗi approval-gate (nhắc nhở khi duyệt sai)"
Cohesion: 0.22
...
### Community 161 - "PLAN — Bộ công cụ export cấu hình Claude Code sang máy khác"
Cohesion: 0.22
...
### Community 162 - "PLAN — Đề xuất tối ưu time/token cho TDQ workflow"
Cohesion: 0.22
...
### Community 163 - "Mini-spec/plan — 2026-08-09-trigger-tieng-viet (lane quick)"
Cohesion: 0.22
...
### Community 164 - "PLAN — Bịt 3 lỗ hổng tick checkbox ở chế độ chuyên sâu"
Cohesion: 0.22
...
### Community 165 - "REPORT — Instruction hardening cho model yếu (tdq-workflow 0.3.0)"
Cohesion: 0.22
...
### Community 166 - "REPORT — Audit toàn diện tdq-workflow 0.6.0"
Cohesion: 0.22
...
### Community 167 - "REPORT — Đổi thiết kế mode external: giao cả plan / theo phase"
Cohesion: 0.22
...
### Community 168 - "REPORT — Đưa skill vào gói external (hybrid 3 nhánh)"
Cohesion: 0.22
...
### Community 169 - "REPORT — Sửa lỗi approval-gate (nhắc nhở khi duyệt sai)"
Cohesion: 0.22
...
### Community 170 - "REPORT — Bộ công cụ export cấu hình Claude Code sang máy khác"
Cohesion: 0.22
...
### Community 171 - "Working log 2026-08-07"
Cohesion: 0.22
...
### Community 173 - "tdq-workflow — Plugin Claude Code"
Cohesion: 0.22
...
### Community 176 - "Hướng dẫn tự cài tdq-workflow ở user-level VÀ project-level (thủ công)"
Cohesion: 0.25
...
### Community 177 - "2026-08-09-sua-mo-ta-skill-inventory"
Cohesion: 0.25
Nodes (7): 2026-08-09-sua-mo-ta-skill-inventory, Chỗ chưa rõ, Hiểu & kiến thức, Hỏi đáp, Mục tiêu, Nguyên văn, Phạm vi đoán

### Community 178 - "KNOWLEDGE — Search agent dùng agy cho advanced search (2026-07-31)"
Cohesion: 0.25
...
### Community 179 - "Knowledge — 2026-07-31-hybrid-deep-search"
Cohesion: 0.25
...
### Community 180 - "KNOWLEDGE — 2026-08-02-tdq-default-cleanup"
Cohesion: 0.25
...
### Community 181 - "PLAN — Vá chặn oan do vân tay repo (0.3.2)"
Cohesion: 0.25
...
### Community 182 - "PLAN — Mode implement "external" (Codex/Antigravity qua worktree) — HOÀN THÀNH (mode main, 2026-07-30 23:10; Q9 PENDING chờ user cài plugin codex)"
Cohesion: 0.25
...
### Community 183 - "PLAN — Tối ưu bộ plugin user-level: tier hoá + lazy-load (HOÀN THÀNH — QC PASS 9/9, 14:58)"
Cohesion: 0.25
...
### Community 184 - "PLAN — Audit toàn bộ workflow TDQ, đề xuất tối ưu token/thời gian (vòng 3)"
Cohesion: 0.25
...
### Community 185 - "Fix lỗi import webm alpha vào Unity 6.3 (Mac)"
Cohesion: 0.25
...
### Community 188 - "QC — Vá điểm mù verify-by-effect (0.3.1)"
Cohesion: 0.25
...
### Community 189 - "Vòng 1 (2026-08-05 03:2x) — đã hỏi, chờ trả lời"
Cohesion: 0.25
...
### Community 190 - "REPORT — Kiểm kê & tận dụng skill phụ trợ (tdq-workflow 0.3.3)"
Cohesion: 0.25
...
### Community 191 - "REPORT — Vá điểm mù verify-by-effect (tdq-workflow 0.3.1)"
Cohesion: 0.25
...
### Community 192 - "REPORT — Tối ưu time/token cho TDQ workflow"
Cohesion: 0.25
...
### Community 193 - "REPORT — Giảm over-engineer & over-test cho TDQ workflow"
Cohesion: 0.25
...
### Community 194 - "Research: 2026-08-04-export-claude-setup"
Cohesion: 0.25
...
### Community 195 - "Brief deep search — LLM local tham số thấp làm engine code-agent (2026-07-31)"
Cohesion: 0.25
...
### Community 196 - "Kiểm kê năng lực (bước B0)"
Cohesion: 0.25
...
### Community 199 - "INSTRUCTIONS — Dựng bundle export cấu hình Claude Code"
Cohesion: 0.29
...
### Community 200 - "Report — TDQWorkflow Plugin v0.1.0 — 2026-07-27"
Cohesion: 0.29
...
### Community 201 - "Knowledge — 2026-07-31-audit-full-workflow"
Cohesion: 0.29
...
### Community 202 - "Knowledge — 2026-08-03-skill-vao-goi-external"
Cohesion: 0.29
...
### Community 203 - "Knowledge: 2026-08-04-export-claude-setup"
Cohesion: 0.29
...
### Community 204 - "PLAN — Ví dụ & hướng dẫn thân thiện cho câu hỏi kiểu A/B/C"
Cohesion: 0.29
...
### Community 206 - "QC — Tối ưu plugin user-level: tier hoá + lazy-load"
Cohesion: 0.29
...
### Community 207 - "REPORT — Đổi nhãn lane: `chế độ nhanh (express)` / `chế độ chuyên sâu (deep)`"
Cohesion: 0.29
...
### Community 208 - "REPORT — Vá chặn oan do vân tay repo (tdq-workflow 0.3.2)"
Cohesion: 0.29
Nodes (6): Còn lại, Kết quả QC, REPORT — Vá chặn oan do vân tay repo (tdq-workflow 0.3.2), Vấn đề, Đã làm gì, Đầu ra

### Community 209 - "REPORT — Tối ưu bộ plugin user-level: tier hoá + lazy-load"
Cohesion: 0.29
...
### Community 210 - "Request: Claude tự quyết implement mode, không hỏi user"
Cohesion: 0.29
...
### Community 211 - "Request: state phải luôn nằm ở project root (chống "state bóng")"
Cohesion: 0.29
...
### Community 212 - "RESEARCH — Search agent dùng agy (2026-07-31)"
Cohesion: 0.29
...
### Community 213 - "Research — 2026-08-04-approval-gate-bug"
Cohesion: 0.29
...
### Community 214 - "Research: Giảm chi phí token/thời gian dài hạn cho agentic coding workflow"
Cohesion: 0.29
...
### Community 215 - "RESEARCH — Bump version + export đầy đủ hơn"
Cohesion: 0.29
...
### Community 216 - "Research: Cấu trúc documentation đầy đủ cho developer tool (CLI plugin)"
Cohesion: 0.29
...
### Community 217 - "Brief deep search — LLM local tham số thấp làm engine code-agent (2026-07-31)"
Cohesion: 0.29
...
### Community 219 - "Chọn model & effort cho sub-agent"
Cohesion: 0.29
...
### Community 224 - "KNOWLEDGE — Tối ưu plugin user-level + lazy-load"
Cohesion: 0.33
...
### Community 231 - "PLAN — Rút gọn UX câu hỏi chọn lane"
Cohesion: 0.33
...
### Community 232 - "QC — Kiểm kê & tận dụng skill phụ trợ (0.3.3)"
Cohesion: 0.33
...
### Community 233 - "QC — Mode implement "external" (Codex/Antigravity qua worktree)"
Cohesion: 0.33
...
### Community 234 - "QC — TDQ workflow là default tuyệt đối + bỏ mục superpower"
Cohesion: 0.33
...
### Community 235 - "QUESTIONS — Siết QC và vòng fix cho lane quick"
Cohesion: 0.33
...
### Community 236 - "Vòng 1 — 2026-08-08 21:5x"
Cohesion: 0.33
...
### Community 237 - "REPORT — Mode implement "external" (Codex/Antigravity qua worktree)"
Cohesion: 0.33
...
### Community 238 - "Report — Hybrid deep search 2 phase (tdq-workflow 0.6.0)"
Cohesion: 0.33
...
### Community 244 - "REQUEST — Kiểm kê & tận dụng skill phụ trợ"
Cohesion: 0.33
...
### Community 245 - "requests/2026-07-31-hybrid-deep-search.md"
Cohesion: 0.33
...
### Community 246 - "REQUEST — Bump version + làm lại bản export đầy đủ hơn"
Cohesion: 0.33
...
### Community 247 - "Request: clone-setting-codex"
Cohesion: 0.33
...
### Community 248 - "Request — tối ưu token/time workflow (vòng 2)"
Cohesion: 0.33
...
### Community 249 - "REQUEST — Siết QC và vòng fix cho lane quick"
Cohesion: 0.33
...
### Community 250 - "RESEARCH — Instruction/skills đủ chắc để model yếu đi đúng workflow"
Cohesion: 0.33
...
### Community 251 - "RESEARCH — Tối ưu plugin user-level + lazy-load"
Cohesion: 0.33
...
### Community 252 - "Research — 2026-07-31-hybrid-deep-search"
Cohesion: 0.33
...
### Community 253 - "Research — 2026-08-03-skill-vao-goi-external"
Cohesion: 0.33
...
### Community 254 - "Brief: phiên bản Python 3 mới nhất"
Cohesion: 0.33
Nodes (5): Brief: phiên bản Python 3 mới nhất, Câu hỏi, Dữ kiện đã có, Ngữ cảnh, Tiêu chí rank

### Community 255 - "Brief: phiên bản Python 3 mới nhất"
Cohesion: 0.33
Nodes (5): Brief: phiên bản Python 3 mới nhất, Câu hỏi, Dữ kiện đã có, Ngữ cảnh, Tiêu chí rank

### Community 256 - "Brief: phiên bản npm mới nhất của 2 package"
Cohesion: 0.33
Nodes (5): Brief: phiên bản npm mới nhất của 2 package, Câu hỏi, Dữ kiện đã có, Ngữ cảnh, Tiêu chí rank

### Community 257 - "Brief: phiên bản Python 3 mới nhất"
Cohesion: 0.33
Nodes (5): Brief: phiên bản Python 3 mới nhất, Câu hỏi, Dữ kiện đã có, Ngữ cảnh, Tiêu chí rank

### Community 258 - "BRIEF — Vector database chạy local cho RAG (2026)"
Cohesion: 0.33
Nodes (5): BRIEF — Vector database chạy local cho RAG (2026), Câu hỏi, Dữ kiện đã có, Ngữ cảnh, Tiêu chí rank

### Community 259 - "Brief — clone-setting-codex (phase 2 đào sâu)"
Cohesion: 0.33
...
### Community 260 - "Brief — clone-setting-codex (phase 2 đào sâu)"
Cohesion: 0.33
Nodes (5): Brief — clone-setting-codex (phase 2 đào sâu), Bối cảnh, Hướng từ phase 1 (route đã chốt cho phase 2), Luật evidence-only, Yêu cầu output

### Community 261 - "Phase `no_state` / `analyze` / chế độ nhanh — Intake"
Cohesion: 0.33
...
### Community 279 - "Questions: 2026-08-04-export-claude-setup"
Cohesion: 0.40
...
### Community 287 - "REQUEST — Tối ưu bộ plugin user-level theo ranking + lazy-load"
Cohesion: 0.40
...
### Community 288 - "REQUEST — Search agent dùng agy cho advanced search, tích hợp TDQ workflow"
Cohesion: 0.40
...
### Community 289 - "REQUEST — Thực thi 5 task P0 của đề xuất tối ưu token"
Cohesion: 0.40
Nodes (4): Chỗ chưa rõ (cần hỏi), Cách hiểu đầu tiên, Nguyên văn yêu cầu, REQUEST — Thực thi 5 task P0 của đề xuất tối ưu token

### Community 290 - "REQUEST — Tối ưu thời gian + token cho TDQ workflow"
Cohesion: 0.40
...
### Community 291 - "Request: Làm TDQ workflow linh hoạt & bớt ma sát"
Cohesion: 0.40
...
### Community 295 - "Request: giảm over-engineer & over-test cho bộ workflow"
Cohesion: 0.40
Nodes (4): Chỗ chưa rõ (cần interview), Hiểu ban đầu, Nguyên văn, Request: giảm over-engineer & over-test cho bộ workflow

### Community 296 - "Research — 2026-07-31-audit-full-workflow"
Cohesion: 0.40
...
### Community 297 - "RESEARCH — 2026-08-02-tdq-default-cleanup"
Cohesion: 0.40
...
### Community 298 - "2.3 Thiết kế state file"
Cohesion: 0.40
...
### Community 299 - "portable/ — dùng TDQ workflow ngoài Claude Code"
Cohesion: 0.40
...
### Community 300 - "Phase `implement` → `qc` → `report`"
Cohesion: 0.40
...
### Community 306 - "Kịch bản đo carry-cost before/after"
Cohesion: 0.40
...
### Community 307 - "references/phases.md"
Cohesion: 0.40
Nodes (3): Bảng phase TDQ (tự sinh — KHÔNG sửa tay), Các bước, TDQ Status

### Community 308 - "Chọn cỡ request: nhỏ, chế độ nhanh (express) hay chế độ chuyên sâu (deep)"
Cohesion: 0.40
...
### Community 315 - "QC — Smoke e2e (E1) — 2026-07-27"
Cohesion: 0.50
Nodes (3): 1. Chain test 2 lane (hook thật, chạy subprocess), 2. Headless CLI thật (`claude -p --plugin-dir .`), QC — Smoke e2e (E1) — 2026-07-27

### Community 316 - "brief/2026-08-11-fix-loi-import-webm-unity.md"
Cohesion: 0.50
Nodes (3): Hiểu & kiến thức, Hỏi đáp, Nguyên văn

### Community 317 - "2026-08-11-tdq-project-codex.md"
Cohesion: 0.50
Nodes (3): Hiểu & kiến thức, Hỏi đáp, Nguyên văn

### Community 318 - "QC — 2026-08-03-skill-vao-goi-external"
Cohesion: 0.50
Nodes (3): Ghi chú, QC — 2026-08-03-skill-vao-goi-external, Đầu ra §2 (9/9 tồn tại)

### Community 319 - "QC — workflow linh hoạt (gộp gate, lane quick đủ bước, lộ trình động)"
Cohesion: 0.50
Nodes (3): Ghi chú, Kết quả, QC — workflow linh hoạt (gộp gate, lane quick đủ bước, lộ trình động)

### Community 320 - "QC — Audit toàn bộ workflow TDQ, đề xuất tối ưu token/thời gian (vòng 3)"
Cohesion: 0.50
...
### Community 325 - "QC — Rút gọn UX câu hỏi chọn lane"
Cohesion: 0.50
Nodes (3): Kết luận, Kết quả, QC — Rút gọn UX câu hỏi chọn lane

### Community 326 - "questions/2026-07-31-agy-search-agent.md"
Cohesion: 0.50
...
### Community 335 - "Hỏi–đáp — tối ưu token vòng 2"
Cohesion: 0.50
Nodes (3): Hỏi–đáp — tối ưu token vòng 2, Vòng 1 (00:52), Vòng 2 (01:10)

### Community 336 - "REQUEST — Mode giao việc cho agent ngoài (codex/antigravity) trong TDQ workflow"
Cohesion: 0.50
...
### Community 415 - "PLAN — Fix dòng giải thích pipeline gây rối khi đọc lại tóm tắt"
Cohesion: 0.33
...
### Community 416 - "Report — Fix dòng giải thích pipeline gây rối khi đọc lại tóm tắt"
Cohesion: 0.40
Nodes (4): Giới hạn còn lại, QC, Report — Fix dòng giải thích pipeline gây rối khi đọc lại tóm tắt, Đã làm

### Community 417 - "QC — Fix dòng giải thích pipeline gây rối khi đọc lại tóm tắt"
Cohesion: 0.50
...
## Knowledge Gaps
- **2107 isolated node(s):** `14:07 — Mở brief rà soát tick ở chế độ chuyên sâu`, `14:20 — Interview xong, viết & trình spec vá tick chế độ chuyên sâu`, `14:32 — Viết & trình plan vá tick chế độ chuyên sâu`, `14:41`, `14:43` (+2102 more)
