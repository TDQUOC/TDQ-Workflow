...
Nhẹ hơn full đúng **4 hạng mục bị bỏ** so với `tdq-build/references/qc.md`: full-suite
toàn repo (quick chỉ chạy test của từng task) · kiểm log service · kiểm không-placeholder ·
kiểm hợp đồng skill `Dùng:/Kiểm/Ra`.
